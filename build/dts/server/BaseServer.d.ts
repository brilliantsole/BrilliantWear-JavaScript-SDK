...
declare abstract class BaseServer<ServerClient extends BaseServerClient> {
    ...
    get addEventListener(): <T extends "*" | "clientConnected" | "clientNotConnected">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<BaseServer<ServerClient>, "clientConnected" | "clientNotConnected", BaseServerEventMessages<ServerClient>, T>) => void, options?: import("../index.ts").EventDispatcherOptions) => void;
