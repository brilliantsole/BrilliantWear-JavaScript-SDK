...
interface TfliteFileConfiguration extends BaseFileConfiguration {
    fileType: "tflite";
    name: string;
...
interface CameraImageFileConfiguration extends BaseFileConfiguration {
...
type FileConfiguration = TfliteFileConfiguration | DisplaySpriteSheetFileConfiguration | CameraImageFileConfiguration;
interface ExtendedFileConfiguration extends BaseFileConfiguration {
    checksum: number;
    length: number;
    indirectly?: boolean;
    buffer: ArrayBuffer;
...
interface DisplaySpriteSheetFileConfiguration extends ExtendedFileConfiguration {
