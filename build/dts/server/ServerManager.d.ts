...
declare class ServerManager {
    ...
    get addEventListener(): <T extends "*" | "server" | "server*" | "serverClientNotConnected" | "serverClientConnected" | "servers">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ServerManager, "server" | "server*" | "serverClientNotConnected" | "serverClientConnected" | "servers", ServerManagerEventMessages, T>) => void, options?: import("../index.ts").EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "*" | "server" | "server*" | "serverClientNotConnected" | "serverClientConnected" | "servers">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ServerManager, "server" | "server*" | "serverClientNotConnected" | "serverClientConnected" | "servers", ServerManagerEventMessages, T>) => void) => void;
