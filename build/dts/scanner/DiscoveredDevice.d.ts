...
declare class DiscoveredDevice {
    ...
    get addEventListener(): <T extends "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "isWifiSecure" | "*" | "device" | "name" | "update" | "expired" | "deviceType" | "rssi">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<DiscoveredDevice, "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "isWifiSecure" | "device" | "name" | "update" | "expired" | "deviceType" | "rssi", DiscoveredDeviceEventMessages, T>) => void, options?: import("../utils/EventDispatcher.ts").EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "isWifiSecure" | "*" | "device" | "name" | "update" | "expired" | "deviceType" | "rssi">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<DiscoveredDevice, "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "isWifiSecure" | "device" | "name" | "update" | "expired" | "deviceType" | "rssi", DiscoveredDeviceEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "isWifiSecure" | "device" | "name" | "update" | "expired" | "deviceType" | "rssi">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<import("../utils/EventDispatcher.ts").ListenerEvent<DiscoveredDevice, "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "isWifiSecure" | "device" | "name" | "update" | "expired" | "deviceType" | "rssi", DiscoveredDeviceEventMessages, T>>;
    toJSON(): {
        bluetoothId: string;
