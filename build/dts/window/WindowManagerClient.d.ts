...
declare class WindowManagerClient {
    #private;
    get addEventListener(): <T extends "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "*" | "serverMessage">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<WindowManagerClient, "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "serverMessage", WindowManagerClientEventMessages, T>) => void, options?: import("../utils/EventDispatcher.ts").EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "*" | "serverMessage">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<WindowManagerClient, "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "serverMessage", WindowManagerClientEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "serverMessage">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<import("../utils/EventDispatcher.ts").ListenerEvent<WindowManagerClient, "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "serverMessage", WindowManagerClientEventMessages, T>>;
