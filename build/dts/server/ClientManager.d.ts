...
declare class ClientManager {
    ...
    constructor();
    get clients(): Client[];
    get addEventListener(): <T extends "*" | "client" | "clientConnected" | "clientNotConnected" | "clients" | "clientConnecting" | "clientDisconnecting" | "clientConnectionStatus" | "clientIsConnected" | "clientIsScanningAvailable" | "clientIsScanning" | "clientDiscoveredDevice" | "clientDiscoveredDevices" | "clientExpiredDiscoveredDevice" | "clientDiscoveredDeviceUpdate" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientScanning" | "clientNotScanning" | "client*">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ClientManager, "client" | "clientConnected" | "clientNotConnected" | "clients" | "clientConnecting" | "clientDisconnecting" | "clientConnectionStatus" | "clientIsConnected" | "clientIsScanningAvailable" | "clientIsScanning" | "clientDiscoveredDevice" | "clientDiscoveredDevices" | "clientExpiredDiscoveredDevice" | "clientDiscoveredDeviceUpdate" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientScanning" | "clientNotScanning" | "client*", ClientManagerEventMessages, T>) => void, options?: import("../utils/EventDispatcher.ts").EventDispatcherOptions) => void;
