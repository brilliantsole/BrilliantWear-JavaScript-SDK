...
declare const _default$a: NullScanner;
...
declare abstract class BaseClient {
    ...
    get addEventListener(): <T extends "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "*" | "isScanningAvailable" | "isScanning" | "discoveredDevice" | "discoveredDeviceUpdate" | "expiredDiscoveredDevice" | "discoveredDevices" | "scanningAvailable" | "scanningNotAvailable" | "scanning" | "notScanning">(type: T, listener: (event: ListenerEvent<BaseClient, "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "isScanningAvailable" | "isScanning" | "discoveredDevice" | "discoveredDeviceUpdate" | "expiredDiscoveredDevice" | "discoveredDevices" | "scanningAvailable" | "scanningNotAvailable" | "scanning" | "notScanning", ClientEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "*" | "isScanningAvailable" | "isScanning" | "discoveredDevice" | "discoveredDeviceUpdate" | "expiredDiscoveredDevice" | "discoveredDevices" | "scanningAvailable" | "scanningNotAvailable" | "scanning" | "notScanning">(type: T, listener: (event: ListenerEvent<BaseClient, "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "isScanningAvailable" | "isScanning" | "discoveredDevice" | "discoveredDeviceUpdate" | "expiredDiscoveredDevice" | "discoveredDevices" | "scanningAvailable" | "scanningNotAvailable" | "scanning" | "notScanning", ClientEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "isScanningAvailable" | "isScanning" | "discoveredDevice" | "discoveredDeviceUpdate" | "expiredDiscoveredDevice" | "discoveredDevices" | "scanningAvailable" | "scanningNotAvailable" | "scanning" | "notScanning">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<BaseClient, "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "isScanningAvailable" | "isScanning" | "discoveredDevice" | "discoveredDeviceUpdate" | "expiredDiscoveredDevice" | "discoveredDevices" | "scanningAvailable" | "scanningNotAvailable" | "scanning" | "notScanning", ClientEventMessages, T>>;
    ...
    private static _defaultReconnectOnDisconnection;
    static get DefaultReconnectOnDisconnection(): boolean;
    static set DefaultReconnectOnDisconnection(newDefaultReconnectOnDisconnection: boolean);
    protected get _isWaitingToReattemptConnection(): boolean;
    protected set _isWaitingToReattemptConnection(newIsWaitingToReattemptConnection: boolean);
    get isWaitingToReattemptConnection(): boolean;
    ...
    protected get _connectionStatus(): "connecting" | "connected" | "disconnecting" | "notConnected";
    protected set _connectionStatus(newConnectionStatus: "connecting" | "connected" | "disconnecting" | "notConnected");
...
declare const _default$9: WindowClient;
...
declare const ConnectionManagers: readonly [typeof BluetoothConnectionManager, typeof WebBluetoothConnectionManager, typeof WebSocketConnectionManager, typeof ClientConnectionManager, ];
...
declare class Device {
    ...
    get clearDisplayContext(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: DisplayCanvasHelper) => Promise<void>;
    ...
    get setDisplayContextState(): (newState: PartialDisplayContextState, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: DisplayCanvasHelper) => Promise<void>;
...
declare const _default$8: DeviceManager;
...
declare class WindowManagerServer {
    #private;
    get addEventListener(): <T extends "*" | "clientConnected" | "clientNotConnected">(type: T, listener: (event: ListenerEvent<WindowManagerServer, "clientConnected" | "clientNotConnected", WindowManagerServerEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "*" | "clientConnected" | "clientNotConnected">(type: T, listener: (event: ListenerEvent<WindowManagerServer, "clientConnected" | "clientNotConnected", WindowManagerServerEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "clientConnected" | "clientNotConnected">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<WindowManagerServer, "clientConnected" | "clientNotConnected", WindowManagerServerEventMessages, T>>;
...
declare const _default$7: WindowManagerServer;
...
declare const _default$6: WindowServer;
...
declare const _default$5: ServerManager;
...
declare const _default$4: ClientManager;
...
declare const _default$3: PubSubManager;
...
declare const _default$2: ScannerManager;
...
type WindowManagerMessage = Message<WindowManagerMessageType>;
...
declare class WindowManagerClient {
    #private;
    get addEventListener(): <T extends "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "*" | "serverMessage">(type: T, listener: (event: ListenerEvent<WindowManagerClient, "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "serverMessage", WindowManagerClientEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "*" | "serverMessage">(type: T, listener: (event: ListenerEvent<WindowManagerClient, "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "serverMessage", WindowManagerClientEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "serverMessage">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<WindowManagerClient, "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "serverMessage", WindowManagerClientEventMessages, T>>;
    get removeEventListeners(): <T extends "connecting" | "connected" | "disconnecting" | "notConnected" | "isConnected" | "connectionStatus" | "*" | "serverMessage">(type: T) => void;
    get removeAllEventListeners(): () => void;
...
declare const DisplayCanvasHelperManagerEventTypes: readonly [...("displayCanvasHelperDevice" | "displayCanvasHelperDeviceConnected" | "displayCanvasHelperDeviceNotConnected" | "displayCanvasHelperDeviceIsConnected" | "displayCanvasHelperContextState" | "displayCanvasHelperNumberOfColors" | "displayCanvasHelperBrightness" | "displayCanvasHelperColor" | "displayCanvasHelperColorOpacity" | "displayCanvasHelperResize" | "displayCanvasHelperUpdate" | "displayCanvasHelperReady" | "displayCanvasHelperDeviceSpriteSheetUploadStart" | "displayCanvasHelperDeviceSpriteSheetUploadProgress" | "displayCanvasHelperDeviceSpriteSheetUploadComplete" | "displayCanvasHelperDeviceUpdated")[], "displayCanvasHelper", "displayCanvasHelpers", "displayCanvasHelper*"];
...
declare class DisplayCanvasHelperManager {
    ...
    get addEventListener(): <T extends "*" | "displayCanvasHelper" | "displayCanvasHelperDevice" | "displayCanvasHelperDeviceConnected" | "displayCanvasHelperDeviceNotConnected" | "displayCanvasHelperDeviceIsConnected" | "displayCanvasHelperContextState" | "displayCanvasHelperNumberOfColors" | "displayCanvasHelperBrightness" | "displayCanvasHelperColor" | "displayCanvasHelperColorOpacity" | "displayCanvasHelperResize" | "displayCanvasHelperUpdate" | "displayCanvasHelperReady" | "displayCanvasHelperDeviceSpriteSheetUploadStart" | "displayCanvasHelperDeviceSpriteSheetUploadProgress" | "displayCanvasHelperDeviceSpriteSheetUploadComplete" | "displayCanvasHelperDeviceUpdated" | "displayCanvasHelpers" | "displayCanvasHelper*">(type: T, listener: (event: ListenerEvent<DisplayCanvasHelperManager, "displayCanvasHelper" | "displayCanvasHelperDevice" | "displayCanvasHelperDeviceConnected" | "displayCanvasHelperDeviceNotConnected" | "displayCanvasHelperDeviceIsConnected" | "displayCanvasHelperContextState" | "displayCanvasHelperNumberOfColors" | "displayCanvasHelperBrightness" | "displayCanvasHelperColor" | "displayCanvasHelperColorOpacity" | "displayCanvasHelperResize" | "displayCanvasHelperUpdate" | "displayCanvasHelperReady" | "displayCanvasHelperDeviceSpriteSheetUploadStart" | "displayCanvasHelperDeviceSpriteSheetUploadProgress" | "displayCanvasHelperDeviceSpriteSheetUploadComplete" | "displayCanvasHelperDeviceUpdated" | "displayCanvasHelpers" | "displayCanvasHelper*", DisplayCanvasHelperManagerEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "*" | "displayCanvasHelper" | "displayCanvasHelperDevice" | "displayCanvasHelperDeviceConnected" | "displayCanvasHelperDeviceNotConnected" | "displayCanvasHelperDeviceIsConnected" | "displayCanvasHelperContextState" | "displayCanvasHelperNumberOfColors" | "displayCanvasHelperBrightness" | "displayCanvasHelperColor" | "displayCanvasHelperColorOpacity" | "displayCanvasHelperResize" | "displayCanvasHelperUpdate" | "displayCanvasHelperReady" | "displayCanvasHelperDeviceSpriteSheetUploadStart" | "displayCanvasHelperDeviceSpriteSheetUploadProgress" | "displayCanvasHelperDeviceSpriteSheetUploadComplete" | "displayCanvasHelperDeviceUpdated" | "displayCanvasHelpers" | "displayCanvasHelper*">(type: T, listener: (event: ListenerEvent<DisplayCanvasHelperManager, "displayCanvasHelper" | "displayCanvasHelperDevice" | "displayCanvasHelperDeviceConnected" | "displayCanvasHelperDeviceNotConnected" | "displayCanvasHelperDeviceIsConnected" | "displayCanvasHelperContextState" | "displayCanvasHelperNumberOfColors" | "displayCanvasHelperBrightness" | "displayCanvasHelperColor" | "displayCanvasHelperColorOpacity" | "displayCanvasHelperResize" | "displayCanvasHelperUpdate" | "displayCanvasHelperReady" | "displayCanvasHelperDeviceSpriteSheetUploadStart" | "displayCanvasHelperDeviceSpriteSheetUploadProgress" | "displayCanvasHelperDeviceSpriteSheetUploadComplete" | "displayCanvasHelperDeviceUpdated" | "displayCanvasHelpers" | "displayCanvasHelper*", DisplayCanvasHelperManagerEventMessages, T>) => void) => void;
    get removeEventListeners(): <T extends "*" | "displayCanvasHelper" | "displayCanvasHelperDevice" | "displayCanvasHelperDeviceConnected" | "displayCanvasHelperDeviceNotConnected" | "displayCanvasHelperDeviceIsConnected" | "displayCanvasHelperContextState" | "displayCanvasHelperNumberOfColors" | "displayCanvasHelperBrightness" | "displayCanvasHelperColor" | "displayCanvasHelperColorOpacity" | "displayCanvasHelperResize" | "displayCanvasHelperUpdate" | "displayCanvasHelperReady" | "displayCanvasHelperDeviceSpriteSheetUploadStart" | "displayCanvasHelperDeviceSpriteSheetUploadProgress" | "displayCanvasHelperDeviceSpriteSheetUploadComplete" | "displayCanvasHelperDeviceUpdated" | "displayCanvasHelpers" | "displayCanvasHelper*">(type: T) => void;
}
