...
export async function waitForGlobals(justBW) {
  ...
  /** @type {import("lit/directives/class-map.js")} */
  const litClassMap = window.litClassMap;
  ...
  /** @type {import("../brilliantwear/brilliantwear.module.js")} */
  /** @type {import("../../../../build/brilliantwear.module.js")} */
  const BW = window.BW;
