...
declare class DiscoveredDevice {
    ...
    get addEventListener(): <T extends "connecting" | "connected" | "disconnecting" | "expired" | "rssi" | "name" | "deviceType" | "ipAddress" | "isWifiSecure" | "update" | "device" | "notConnected" | "connectionStatus" | "isConnected" | "*">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<DiscoveredDevice, "connecting" | "connected" | "disconnecting" | "expired" | "rssi" | "name" | "deviceType" | "ipAddress" | "isWifiSecure" | "update" | "device" | "notConnected" | "connectionStatus" | "isConnected", DiscoveredDeviceEventMessages, T>) => void, options?: import("../utils/EventDispatcher.ts").EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "connecting" | "connected" | "disconnecting" | "expired" | "rssi" | "name" | "deviceType" | "ipAddress" | "isWifiSecure" | "update" | "device" | "notConnected" | "connectionStatus" | "isConnected" | "*">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<DiscoveredDevice, "connecting" | "connected" | "disconnecting" | "expired" | "rssi" | "name" | "deviceType" | "ipAddress" | "isWifiSecure" | "update" | "device" | "notConnected" | "connectionStatus" | "isConnected", DiscoveredDeviceEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "connecting" | "connected" | "disconnecting" | "expired" | "rssi" | "name" | "deviceType" | "ipAddress" | "isWifiSecure" | "update" | "device" | "notConnected" | "connectionStatus" | "isConnected">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<import("../utils/EventDispatcher.ts").ListenerEvent<DiscoveredDevice, "connecting" | "connected" | "disconnecting" | "expired" | "rssi" | "name" | "deviceType" | "ipAddress" | "isWifiSecure" | "update" | "device" | "notConnected" | "connectionStatus" | "isConnected", DiscoveredDeviceEventMessages, T>>;
    toJSON(): {
        bluetoothId: string;
