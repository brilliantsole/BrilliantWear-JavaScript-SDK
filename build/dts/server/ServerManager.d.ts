...
export declare const ServerManagerEventTypes: readonly [...("serverClientNotConnected" | "serverClientConnected")[], "server", "servers", "server*"];
...
declare class ServerManager {
    ...
    get addEventListener(): <T extends "*" | "server" | "serverClientNotConnected" | "serverClientConnected" | "servers" | "server*">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ServerManager, "server" | "serverClientNotConnected" | "serverClientConnected" | "servers" | "server*", ServerManagerEventMessages, T>) => void, options?: import("../index.ts").EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "*" | "server" | "serverClientNotConnected" | "serverClientConnected" | "servers" | "server*">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<ServerManager, "server" | "serverClientNotConnected" | "serverClientConnected" | "servers" | "server*", ServerManagerEventMessages, T>) => void) => void;
