...
declare const isInWKWebView: boolean;
...
declare const environment_d_isInWKWebView: typeof isInWKWebView;
...
declare namespace environment_d {
  export {
    ...
    environment_d_isInWKWebView as isInWKWebView,
...
declare const ConnectionTypes: readonly ["none", "bluetooth", "client", "webSocket", "udp"];
type ConnectionType = (typeof ConnectionTypes)[number];
declare const ClientConnectionTypes: readonly ["bluetooth", "webSocket", "udp"];
type ClientConnectionType = (typeof ClientConnectionTypes)[number];
interface BaseConnectOptions {
    type?: ConnectionType;
}
interface BluetoothConnectOptions extends BaseConnectOptions {
    type: "bluetooth";
}
...
type MessageSentCallback = (message: TxMessage, indirectly?: boolean) => void;
type MessagesSentCallback = (messages: TxMessage[], indirectly?: boolean) => void;
...
interface BaseTfliteFileConfiguration {
    fileType: "tflite";
    name: string;
...
type TfliteFileConfiguration = BaseFileConfiguration & BaseTfliteFileConfiguration;
type ExtendedTfliteFileConfiguration = BaseExtendedFileConfiguration & BaseTfliteFileConfiguration;
...
interface BaseCameraImageFileConfiguration extends BaseFileConfiguration {
    fileType: "cameraImage";
    cameraImage: CameraImage;
}
type CameraImageFileConfiguration = BaseFileConfiguration & BaseCameraImageFileConfiguration;
type ExtendedCameraImageFileConfiguration = BaseExtendedFileConfiguration & BaseCameraImageFileConfiguration;

interface BaseWifiServerKeyFileConfiguration {
    fileType: "wifiServerKey";
}
type WifiServerKeyFileConfiguration = BaseFileConfiguration & BaseWifiServerKeyFileConfiguration;
type ExtendedWifiServerKeyFileConfiguration = BaseExtendedFileConfiguration & BaseWifiServerKeyFileConfiguration;
interface BaseWifiServerCertFileConfiguration {
    fileType: "wifiServerCert";
}
type WifiServerCertFileConfiguration = BaseFileConfiguration & BaseWifiServerCertFileConfiguration;
type ExtendedWifiServerCertFileConfiguration = BaseExtendedFileConfiguration & BaseWifiServerCertFileConfiguration;
...
interface BaseFileConfiguration {
    readonly fileType: FileType;
    file: FileLike;
}
interface BaseExtendedFileConfiguration extends BaseFileConfiguration {
    checksum: number;
    length: number;
    indirectly?: boolean;
    buffer: ArrayBuffer;
...
type FileConfiguration = TfliteFileConfiguration | DisplaySpriteSheetFileConfiguration | CameraImageFileConfiguration | WifiServerCertFileConfiguration | WifiServerKeyFileConfiguration;
type ExtendedFileConfiguration = ExtendedTfliteFileConfiguration | ExtendedDisplaySpriteSheetFileConfiguration | ExtendedCameraImageFileConfiguration | ExtendedWifiServerCertFileConfiguration | ExtendedWifiServerKeyFileConfiguration;
...
declare class DisplayCanvasHelper implements DisplayManagerInterface {
    ...
    constructor();
    get addEventListener(): <T extends "device" | "deviceConnected" | "deviceNotConnected" | "deviceIsConnected" | "*" | "contextState" | "numberOfColors" | "brightness" | "color" | "colorOpacity" | "resize" | "update" | "ready" | "deviceSpriteSheetUploadStart" | "deviceSpriteSheetUploadProgress" | "deviceSpriteSheetUploadComplete" | "deviceUpdated">(type: T, listener: (event: ListenerEvent<DisplayCanvasHelper, "device" | "deviceConnected" | "deviceNotConnected" | "deviceIsConnected" | "contextState" | "numberOfColors" | "brightness" | "color" | "colorOpacity" | "resize" | "update" | "ready" | "deviceSpriteSheetUploadStart" | "deviceSpriteSheetUploadProgress" | "deviceSpriteSheetUploadComplete" | "deviceUpdated", DisplayCanvasHelperEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "device" | "deviceConnected" | "deviceNotConnected" | "deviceIsConnected" | "*" | "contextState" | "numberOfColors" | "brightness" | "color" | "colorOpacity" | "resize" | "update" | "ready" | "deviceSpriteSheetUploadStart" | "deviceSpriteSheetUploadProgress" | "deviceSpriteSheetUploadComplete" | "deviceUpdated">(type: T, listener: (event: ListenerEvent<DisplayCanvasHelper, "device" | "deviceConnected" | "deviceNotConnected" | "deviceIsConnected" | "contextState" | "numberOfColors" | "brightness" | "color" | "colorOpacity" | "resize" | "update" | "ready" | "deviceSpriteSheetUploadStart" | "deviceSpriteSheetUploadProgress" | "deviceSpriteSheetUploadComplete" | "deviceUpdated", DisplayCanvasHelperEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "device" | "deviceConnected" | "deviceNotConnected" | "deviceIsConnected" | "contextState" | "numberOfColors" | "brightness" | "color" | "colorOpacity" | "resize" | "update" | "ready" | "deviceSpriteSheetUploadStart" | "deviceSpriteSheetUploadProgress" | "deviceSpriteSheetUploadComplete" | "deviceUpdated">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<DisplayCanvasHelper, "device" | "deviceConnected" | "deviceNotConnected" | "deviceIsConnected" | "contextState" | "numberOfColors" | "brightness" | "color" | "colorOpacity" | "resize" | "update" | "ready" | "deviceSpriteSheetUploadStart" | "deviceSpriteSheetUploadProgress" | "deviceSpriteSheetUploadComplete" | "deviceUpdated", DisplayCanvasHelperEventMessages, T>>;
    get removeEventListeners(): <T extends "device" | "deviceConnected" | "deviceNotConnected" | "deviceIsConnected" | "*" | "contextState" | "numberOfColors" | "brightness" | "color" | "colorOpacity" | "resize" | "update" | "ready" | "deviceSpriteSheetUploadStart" | "deviceSpriteSheetUploadProgress" | "deviceSpriteSheetUploadComplete" | "deviceUpdated">(type: T) => void;
    removeAllEventListeners(): void;
    ...
    stringToSpriteLinesMetrics(string: string, requireAll?: boolean, maxLineBreadth?: number, separators?: string[], isSending?: boolean): DisplaySpriteLinesMetrics;
...
interface BaseDisplaySpriteSheetFileConfiguration {
    fileType: "spriteSheet";
    spriteSheetIndex?: number;
    spriteSheet: DisplaySpriteSheet;
}
type DisplaySpriteSheetFileConfiguration = BaseFileConfiguration & BaseDisplaySpriteSheetFileConfiguration;
type ExtendedDisplaySpriteSheetFileConfiguration = BaseExtendedFileConfiguration & BaseDisplaySpriteSheetFileConfiguration;
...
declare const serviceUUIDs: BluetoothServiceUUID[];
declare const optionalServiceUUIDs: BluetoothServiceUUID[];
declare const allServiceUUIDs: BluetoothServiceUUID[];
declare function getServiceNameFromUUID(serviceUUID: BluetoothServiceUUID): BluetoothServiceName | undefined;
declare const characteristicUUIDs: BluetoothCharacteristicUUID[];
declare const allCharacteristicUUIDs: BluetoothCharacteristicUUID[];
declare const characteristicNames: BluetoothCharacteristicName[];
declare const allCharacteristicNames: BluetoothCharacteristicName[];
declare function getCharacteristicNameFromUUID(characteristicUUID: BluetoothCharacteristicUUID): BluetoothCharacteristicName | undefined;
declare function getCharacteristicProperties(characteristicName: BluetoothCharacteristicName): BluetoothCharacteristicProperties;
declare const serviceDataUUID = "0000";

type bluetoothUUIDs_d_BluetoothCharacteristicName = BluetoothCharacteristicName;
type bluetoothUUIDs_d_BluetoothServiceName = BluetoothServiceName;
declare const bluetoothUUIDs_d_allCharacteristicNames: typeof allCharacteristicNames;
declare const bluetoothUUIDs_d_allCharacteristicUUIDs: typeof allCharacteristicUUIDs;
declare const bluetoothUUIDs_d_allServiceUUIDs: typeof allServiceUUIDs;
declare const bluetoothUUIDs_d_characteristicNames: typeof characteristicNames;
declare const bluetoothUUIDs_d_characteristicUUIDs: typeof characteristicUUIDs;
declare const bluetoothUUIDs_d_getCharacteristicNameFromUUID: typeof getCharacteristicNameFromUUID;
declare const bluetoothUUIDs_d_getCharacteristicProperties: typeof getCharacteristicProperties;
declare const bluetoothUUIDs_d_getServiceNameFromUUID: typeof getServiceNameFromUUID;
declare const bluetoothUUIDs_d_optionalServiceUUIDs: typeof optionalServiceUUIDs;
declare const bluetoothUUIDs_d_serviceDataUUID: typeof serviceDataUUID;
declare const bluetoothUUIDs_d_serviceUUIDs: typeof serviceUUIDs;
declare namespace bluetoothUUIDs_d {
  export { bluetoothUUIDs_d_allCharacteristicNames as allCharacteristicNames, bluetoothUUIDs_d_allCharacteristicUUIDs as allCharacteristicUUIDs, bluetoothUUIDs_d_allServiceUUIDs as allServiceUUIDs, bluetoothUUIDs_d_characteristicNames as characteristicNames, bluetoothUUIDs_d_characteristicUUIDs as characteristicUUIDs, bluetoothUUIDs_d_getCharacteristicNameFromUUID as getCharacteristicNameFromUUID, bluetoothUUIDs_d_getCharacteristicProperties as getCharacteristicProperties, bluetoothUUIDs_d_getServiceNameFromUUID as getServiceNameFromUUID, bluetoothUUIDs_d_optionalServiceUUIDs as optionalServiceUUIDs, bluetoothUUIDs_d_serviceDataUUID as serviceDataUUID, bluetoothUUIDs_d_serviceUUIDs as serviceUUIDs };
  export type { bluetoothUUIDs_d_BluetoothCharacteristicName as BluetoothCharacteristicName, bluetoothUUIDs_d_BluetoothServiceName as BluetoothServiceName };
}
...
declare const _default$5: NullScanner;

type ScannerLike = BaseScanner | Client;

interface DiscoveredDeviceMetadata {
    bluetoothId: string;
    name: string;
...
type DiscoveredDeviceMetadataKeys = (keyof DiscoveredDeviceMetadata)[];
interface DiscoveredDeviceEventMessages {
    expired: {};
    rssi: {
        rssi: number;
    };
...
declare class DiscoveredDevice {
    ...
    get addEventListener(): <T extends "connecting" | "connected" | "disconnecting" | "ipAddress" | "isWifiSecure" | "notConnected" | "isConnected" | "device" | "connectionStatus" | "*" | "update" | "expired" | "name" | "deviceType" | "rssi">(type: T, listener: (event: ListenerEvent<DiscoveredDevice, "connecting" | "connected" | "disconnecting" | "ipAddress" | "isWifiSecure" | "notConnected" | "isConnected" | "device" | "connectionStatus" | "update" | "expired" | "name" | "deviceType" | "rssi", DiscoveredDeviceEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "connecting" | "connected" | "disconnecting" | "ipAddress" | "isWifiSecure" | "notConnected" | "isConnected" | "device" | "connectionStatus" | "*" | "update" | "expired" | "name" | "deviceType" | "rssi">(type: T, listener: (event: ListenerEvent<DiscoveredDevice, "connecting" | "connected" | "disconnecting" | "ipAddress" | "isWifiSecure" | "notConnected" | "isConnected" | "device" | "connectionStatus" | "update" | "expired" | "name" | "deviceType" | "rssi", DiscoveredDeviceEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "connecting" | "connected" | "disconnecting" | "ipAddress" | "isWifiSecure" | "notConnected" | "isConnected" | "device" | "connectionStatus" | "update" | "expired" | "name" | "deviceType" | "rssi">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<DiscoveredDevice, "connecting" | "connected" | "disconnecting" | "ipAddress" | "isWifiSecure" | "notConnected" | "isConnected" | "device" | "connectionStatus" | "update" | "expired" | "name" | "deviceType" | "rssi", DiscoveredDeviceEventMessages, T>>;
    toJSON(): {
        bluetoothId: string;
...
declare const ScannerEventTypes: readonly ["isScanningAvailable", "isScanning", "discoveredDevice", "discoveredDeviceUpdate", "expiredDiscoveredDevice", "discoveredDevices", "scanningAvailable", "scanningNotAvailable", "scanning", "notScanning"];
...
declare abstract class BaseScanner {
    ...
    get waitForEvent(): <T extends "isScanningAvailable" | "isScanning" | "discoveredDevice" | "discoveredDeviceUpdate" | "expiredDiscoveredDevice" | "discoveredDevices" | "scanningAvailable" | "scanningNotAvailable" | "scanning" | "notScanning">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<BaseScanner, "isScanningAvailable" | "isScanning" | "discoveredDevice" | "discoveredDeviceUpdate" | "expiredDiscoveredDevice" | "discoveredDevices" | "scanningAvailable" | "scanningNotAvailable" | "scanning" | "notScanning", ScannerEventMessages, T>>;
    get isScanningAvailable(): boolean;
...
declare const ServerMessageTypes: readonly ["isScanningAvailable", "isScanning", "startScan", "stopScan", "discoveredDevice", "discoveredDevices", "expiredDiscoveredDevice", "connectToDevice", "disconnectFromDevice", "connectedDevices", "deviceMessage", "requiredDeviceInformation", "pubSub"];
...
declare const ConnectionManagers: readonly [typeof BluetoothConnectionManager, typeof WebBluetoothConnectionManager, typeof WebSocketConnectionManager, typeof ClientConnectionManager, typeof NobleConnectionManager, typeof UDPConnectionManager];
type ConnectionManager = InstanceType<NonNullable<(typeof ConnectionManagers)[number]>>;
...
declare class Device {
    ...
    constructor();
    get addEventListener(): <T extends "manufacturerName" | "modelNumber" | "hardwareRevision" | "firmwareRevision" | "softwareRevision" | "pnpId" | "serialNumber" | "batteryLevel" | "rx" | "tx" | "smp" | "connecting" | "connected" | "disconnecting" | "isCharging" | "getBatteryCurrent" | "getMtu" | "getId" | "getName" | "setName" | "getType" | "setType" | "getCurrentTime" | "setCurrentTime" | "getSensorConfiguration" | "setSensorConfiguration" | "getPressurePositions" | "getSensorScalars" | "sensorData" | "getVibrationLocations" | "triggerVibration" | "getFileTypes" | "maxFileLength" | "getFileType" | "setFileType" | "getFileLength" | "setFileLength" | "getFileChecksum" | "setFileChecksum" | "setFileTransferCommand" | "fileTransferStatus" | "getFileBlock" | "setFileBlock" | "fileBytesTransferred" | "getTfliteName" | "setTfliteName" | "getTfliteTask" | "setTfliteTask" | "getTfliteSampleRate" | "setTfliteSampleRate" | "getTfliteSensorTypes" | "setTfliteSensorTypes" | "tfliteIsReady" | "getTfliteCaptureDelay" | "setTfliteCaptureDelay" | "getTfliteThreshold" | "setTfliteThreshold" | "getTfliteInferencingEnabled" | "setTfliteInferencingEnabled" | "tfliteInference" | "isWifiAvailable" | "getWifiSSID" | "setWifiSSID" | "getWifiPassword" | "setWifiPassword" | "getWifiConnectionEnabled" | "setWifiConnectionEnabled" | "isWifiConnected" | "ipAddress" | "isWifiSecure" | "cameraStatus" | "cameraCommand" | "getCameraConfiguration" | "setCameraConfiguration" | "cameraData" | "microphoneStatus" | "microphoneCommand" | "getMicrophoneConfiguration" | "setMicrophoneConfiguration" | "microphoneData" | "isDisplayAvailable" | "displayStatus" | "displayInformation" | "displayCommand" | "getDisplayBrightness" | "setDisplayBrightness" | "displayContextCommands" | "displayReady" | "getDisplaySpriteSheetName" | "setDisplaySpriteSheetName" | "displaySpriteSheetIndex" | "getSensorCounts" | "getLedInformation" | "setLeds" | "clearLeds" | "deviceInformation" | "notConnected" | "isConnected" | "barometer" | "acceleration" | "gravity" | "linearAcceleration" | "gyroscope" | "magnetometer" | "gameRotation" | "rotation" | "orientation" | "stepDetector" | "stepCounter" | "activity" | "deviceOrientation" | "tapDetector" | "pressure" | "buttons" | "touches" | "light" | "connectionMessage" | "connectionStatus" | "pressureAutoRangeEnabled" | "pressureAutoRangeDisabled" | "pressureAutoRange" | "pressureMotionAutoRangeEnabled" | "pressureMotionAutoRangeDisabled" | "pressureMotionAutoRange" | "isRecordingPressureCalibrationData" | "pressureCalibrationDataRecordStart" | "pressureCalibrationDataRecordStop" | "pressureCalibrationDataRecordingProgress" | "isTrainingPressureCalibration" | "pressureCalibrationTrainStart" | "pressureCalibrationTrainEnd" | "pressureCalibrationTrainProgress" | "calibratedPressureModel" | "numberOfButtons" | "button" | "buttonDown" | "buttonUp" | "numberOfTouches" | "touch" | "touchDown" | "touchUp" | "fileTransferProgress" | "fileTransferComplete" | "fileReceived" | "fileSent" | "cameraImageProgress" | "cameraImage" | "isRecordingCamera" | "cameraRecording" | "autoPicture" | "startRecordingCamera" | "stopRecordingCamera" | "isRecordingMicrophone" | "microphoneRecording" | "startRecordingMicrophone" | "stopRecordingMicrophone" | "displayContextState" | "displayColor" | "displayColorOpacity" | "displayOpacity" | "displaySpriteSheetUploadStart" | "displaySpriteSheetUploadProgress" | "displaySpriteSheetUploadComplete" | "setLed" | "firmwareImages" | "firmwareUploadProgress" | "firmwareStatus" | "camera" | "microphone" | "firmwareUploadComplete" | "*">(type: T, listener: (event: ListenerEvent<Device, "manufacturerName" | "modelNumber" | "hardwareRevision" | "firmwareRevision" | "softwareRevision" | "pnpId" | "serialNumber" | "batteryLevel" | "rx" | "tx" | "smp" | "connecting" | "connected" | "disconnecting" | "isCharging" | "getBatteryCurrent" | "getMtu" | "getId" | "getName" | "setName" | "getType" | "setType" | "getCurrentTime" | "setCurrentTime" | "getSensorConfiguration" | "setSensorConfiguration" | "getPressurePositions" | "getSensorScalars" | "sensorData" | "getVibrationLocations" | "triggerVibration" | "getFileTypes" | "maxFileLength" | "getFileType" | "setFileType" | "getFileLength" | "setFileLength" | "getFileChecksum" | "setFileChecksum" | "setFileTransferCommand" | "fileTransferStatus" | "getFileBlock" | "setFileBlock" | "fileBytesTransferred" | "getTfliteName" | "setTfliteName" | "getTfliteTask" | "setTfliteTask" | "getTfliteSampleRate" | "setTfliteSampleRate" | "getTfliteSensorTypes" | "setTfliteSensorTypes" | "tfliteIsReady" | "getTfliteCaptureDelay" | "setTfliteCaptureDelay" | "getTfliteThreshold" | "setTfliteThreshold" | "getTfliteInferencingEnabled" | "setTfliteInferencingEnabled" | "tfliteInference" | "isWifiAvailable" | "getWifiSSID" | "setWifiSSID" | "getWifiPassword" | "setWifiPassword" | "getWifiConnectionEnabled" | "setWifiConnectionEnabled" | "isWifiConnected" | "ipAddress" | "isWifiSecure" | "cameraStatus" | "cameraCommand" | "getCameraConfiguration" | "setCameraConfiguration" | "cameraData" | "microphoneStatus" | "microphoneCommand" | "getMicrophoneConfiguration" | "setMicrophoneConfiguration" | "microphoneData" | "isDisplayAvailable" | "displayStatus" | "displayInformation" | "displayCommand" | "getDisplayBrightness" | "setDisplayBrightness" | "displayContextCommands" | "displayReady" | "getDisplaySpriteSheetName" | "setDisplaySpriteSheetName" | "displaySpriteSheetIndex" | "getSensorCounts" | "getLedInformation" | "setLeds" | "clearLeds" | "deviceInformation" | "notConnected" | "isConnected" | "barometer" | "acceleration" | "gravity" | "linearAcceleration" | "gyroscope" | "magnetometer" | "gameRotation" | "rotation" | "orientation" | "stepDetector" | "stepCounter" | "activity" | "deviceOrientation" | "tapDetector" | "pressure" | "buttons" | "touches" | "light" | "connectionMessage" | "connectionStatus" | "pressureAutoRangeEnabled" | "pressureAutoRangeDisabled" | "pressureAutoRange" | "pressureMotionAutoRangeEnabled" | "pressureMotionAutoRangeDisabled" | "pressureMotionAutoRange" | "isRecordingPressureCalibrationData" | "pressureCalibrationDataRecordStart" | "pressureCalibrationDataRecordStop" | "pressureCalibrationDataRecordingProgress" | "isTrainingPressureCalibration" | "pressureCalibrationTrainStart" | "pressureCalibrationTrainEnd" | "pressureCalibrationTrainProgress" | "calibratedPressureModel" | "numberOfButtons" | "button" | "buttonDown" | "buttonUp" | "numberOfTouches" | "touch" | "touchDown" | "touchUp" | "fileTransferProgress" | "fileTransferComplete" | "fileReceived" | "fileSent" | "cameraImageProgress" | "cameraImage" | "isRecordingCamera" | "cameraRecording" | "autoPicture" | "startRecordingCamera" | "stopRecordingCamera" | "isRecordingMicrophone" | "microphoneRecording" | "startRecordingMicrophone" | "stopRecordingMicrophone" | "displayContextState" | "displayColor" | "displayColorOpacity" | "displayOpacity" | "displaySpriteSheetUploadStart" | "displaySpriteSheetUploadProgress" | "displaySpriteSheetUploadComplete" | "setLed" | "firmwareImages" | "firmwareUploadProgress" | "firmwareStatus" | "camera" | "microphone" | "firmwareUploadComplete", DeviceEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "manufacturerName" | "modelNumber" | "hardwareRevision" | "firmwareRevision" | "softwareRevision" | "pnpId" | "serialNumber" | "batteryLevel" | "rx" | "tx" | "smp" | "connecting" | "connected" | "disconnecting" | "isCharging" | "getBatteryCurrent" | "getMtu" | "getId" | "getName" | "setName" | "getType" | "setType" | "getCurrentTime" | "setCurrentTime" | "getSensorConfiguration" | "setSensorConfiguration" | "getPressurePositions" | "getSensorScalars" | "sensorData" | "getVibrationLocations" | "triggerVibration" | "getFileTypes" | "maxFileLength" | "getFileType" | "setFileType" | "getFileLength" | "setFileLength" | "getFileChecksum" | "setFileChecksum" | "setFileTransferCommand" | "fileTransferStatus" | "getFileBlock" | "setFileBlock" | "fileBytesTransferred" | "getTfliteName" | "setTfliteName" | "getTfliteTask" | "setTfliteTask" | "getTfliteSampleRate" | "setTfliteSampleRate" | "getTfliteSensorTypes" | "setTfliteSensorTypes" | "tfliteIsReady" | "getTfliteCaptureDelay" | "setTfliteCaptureDelay" | "getTfliteThreshold" | "setTfliteThreshold" | "getTfliteInferencingEnabled" | "setTfliteInferencingEnabled" | "tfliteInference" | "isWifiAvailable" | "getWifiSSID" | "setWifiSSID" | "getWifiPassword" | "setWifiPassword" | "getWifiConnectionEnabled" | "setWifiConnectionEnabled" | "isWifiConnected" | "ipAddress" | "isWifiSecure" | "cameraStatus" | "cameraCommand" | "getCameraConfiguration" | "setCameraConfiguration" | "cameraData" | "microphoneStatus" | "microphoneCommand" | "getMicrophoneConfiguration" | "setMicrophoneConfiguration" | "microphoneData" | "isDisplayAvailable" | "displayStatus" | "displayInformation" | "displayCommand" | "getDisplayBrightness" | "setDisplayBrightness" | "displayContextCommands" | "displayReady" | "getDisplaySpriteSheetName" | "setDisplaySpriteSheetName" | "displaySpriteSheetIndex" | "getSensorCounts" | "getLedInformation" | "setLeds" | "clearLeds" | "deviceInformation" | "notConnected" | "isConnected" | "barometer" | "acceleration" | "gravity" | "linearAcceleration" | "gyroscope" | "magnetometer" | "gameRotation" | "rotation" | "orientation" | "stepDetector" | "stepCounter" | "activity" | "deviceOrientation" | "tapDetector" | "pressure" | "buttons" | "touches" | "light" | "connectionMessage" | "connectionStatus" | "pressureAutoRangeEnabled" | "pressureAutoRangeDisabled" | "pressureAutoRange" | "pressureMotionAutoRangeEnabled" | "pressureMotionAutoRangeDisabled" | "pressureMotionAutoRange" | "isRecordingPressureCalibrationData" | "pressureCalibrationDataRecordStart" | "pressureCalibrationDataRecordStop" | "pressureCalibrationDataRecordingProgress" | "isTrainingPressureCalibration" | "pressureCalibrationTrainStart" | "pressureCalibrationTrainEnd" | "pressureCalibrationTrainProgress" | "calibratedPressureModel" | "numberOfButtons" | "button" | "buttonDown" | "buttonUp" | "numberOfTouches" | "touch" | "touchDown" | "touchUp" | "fileTransferProgress" | "fileTransferComplete" | "fileReceived" | "fileSent" | "cameraImageProgress" | "cameraImage" | "isRecordingCamera" | "cameraRecording" | "autoPicture" | "startRecordingCamera" | "stopRecordingCamera" | "isRecordingMicrophone" | "microphoneRecording" | "startRecordingMicrophone" | "stopRecordingMicrophone" | "displayContextState" | "displayColor" | "displayColorOpacity" | "displayOpacity" | "displaySpriteSheetUploadStart" | "displaySpriteSheetUploadProgress" | "displaySpriteSheetUploadComplete" | "setLed" | "firmwareImages" | "firmwareUploadProgress" | "firmwareStatus" | "camera" | "microphone" | "firmwareUploadComplete" | "*">(type: T, listener: (event: ListenerEvent<Device, "manufacturerName" | "modelNumber" | "hardwareRevision" | "firmwareRevision" | "softwareRevision" | "pnpId" | "serialNumber" | "batteryLevel" | "rx" | "tx" | "smp" | "connecting" | "connected" | "disconnecting" | "isCharging" | "getBatteryCurrent" | "getMtu" | "getId" | "getName" | "setName" | "getType" | "setType" | "getCurrentTime" | "setCurrentTime" | "getSensorConfiguration" | "setSensorConfiguration" | "getPressurePositions" | "getSensorScalars" | "sensorData" | "getVibrationLocations" | "triggerVibration" | "getFileTypes" | "maxFileLength" | "getFileType" | "setFileType" | "getFileLength" | "setFileLength" | "getFileChecksum" | "setFileChecksum" | "setFileTransferCommand" | "fileTransferStatus" | "getFileBlock" | "setFileBlock" | "fileBytesTransferred" | "getTfliteName" | "setTfliteName" | "getTfliteTask" | "setTfliteTask" | "getTfliteSampleRate" | "setTfliteSampleRate" | "getTfliteSensorTypes" | "setTfliteSensorTypes" | "tfliteIsReady" | "getTfliteCaptureDelay" | "setTfliteCaptureDelay" | "getTfliteThreshold" | "setTfliteThreshold" | "getTfliteInferencingEnabled" | "setTfliteInferencingEnabled" | "tfliteInference" | "isWifiAvailable" | "getWifiSSID" | "setWifiSSID" | "getWifiPassword" | "setWifiPassword" | "getWifiConnectionEnabled" | "setWifiConnectionEnabled" | "isWifiConnected" | "ipAddress" | "isWifiSecure" | "cameraStatus" | "cameraCommand" | "getCameraConfiguration" | "setCameraConfiguration" | "cameraData" | "microphoneStatus" | "microphoneCommand" | "getMicrophoneConfiguration" | "setMicrophoneConfiguration" | "microphoneData" | "isDisplayAvailable" | "displayStatus" | "displayInformation" | "displayCommand" | "getDisplayBrightness" | "setDisplayBrightness" | "displayContextCommands" | "displayReady" | "getDisplaySpriteSheetName" | "setDisplaySpriteSheetName" | "displaySpriteSheetIndex" | "getSensorCounts" | "getLedInformation" | "setLeds" | "clearLeds" | "deviceInformation" | "notConnected" | "isConnected" | "barometer" | "acceleration" | "gravity" | "linearAcceleration" | "gyroscope" | "magnetometer" | "gameRotation" | "rotation" | "orientation" | "stepDetector" | "stepCounter" | "activity" | "deviceOrientation" | "tapDetector" | "pressure" | "buttons" | "touches" | "light" | "connectionMessage" | "connectionStatus" | "pressureAutoRangeEnabled" | "pressureAutoRangeDisabled" | "pressureAutoRange" | "pressureMotionAutoRangeEnabled" | "pressureMotionAutoRangeDisabled" | "pressureMotionAutoRange" | "isRecordingPressureCalibrationData" | "pressureCalibrationDataRecordStart" | "pressureCalibrationDataRecordStop" | "pressureCalibrationDataRecordingProgress" | "isTrainingPressureCalibration" | "pressureCalibrationTrainStart" | "pressureCalibrationTrainEnd" | "pressureCalibrationTrainProgress" | "calibratedPressureModel" | "numberOfButtons" | "button" | "buttonDown" | "buttonUp" | "numberOfTouches" | "touch" | "touchDown" | "touchUp" | "fileTransferProgress" | "fileTransferComplete" | "fileReceived" | "fileSent" | "cameraImageProgress" | "cameraImage" | "isRecordingCamera" | "cameraRecording" | "autoPicture" | "startRecordingCamera" | "stopRecordingCamera" | "isRecordingMicrophone" | "microphoneRecording" | "startRecordingMicrophone" | "stopRecordingMicrophone" | "displayContextState" | "displayColor" | "displayColorOpacity" | "displayOpacity" | "displaySpriteSheetUploadStart" | "displaySpriteSheetUploadProgress" | "displaySpriteSheetUploadComplete" | "setLed" | "firmwareImages" | "firmwareUploadProgress" | "firmwareStatus" | "camera" | "microphone" | "firmwareUploadComplete", DeviceEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "manufacturerName" | "modelNumber" | "hardwareRevision" | "firmwareRevision" | "softwareRevision" | "pnpId" | "serialNumber" | "batteryLevel" | "rx" | "tx" | "smp" | "connecting" | "connected" | "disconnecting" | "isCharging" | "getBatteryCurrent" | "getMtu" | "getId" | "getName" | "setName" | "getType" | "setType" | "getCurrentTime" | "setCurrentTime" | "getSensorConfiguration" | "setSensorConfiguration" | "getPressurePositions" | "getSensorScalars" | "sensorData" | "getVibrationLocations" | "triggerVibration" | "getFileTypes" | "maxFileLength" | "getFileType" | "setFileType" | "getFileLength" | "setFileLength" | "getFileChecksum" | "setFileChecksum" | "setFileTransferCommand" | "fileTransferStatus" | "getFileBlock" | "setFileBlock" | "fileBytesTransferred" | "getTfliteName" | "setTfliteName" | "getTfliteTask" | "setTfliteTask" | "getTfliteSampleRate" | "setTfliteSampleRate" | "getTfliteSensorTypes" | "setTfliteSensorTypes" | "tfliteIsReady" | "getTfliteCaptureDelay" | "setTfliteCaptureDelay" | "getTfliteThreshold" | "setTfliteThreshold" | "getTfliteInferencingEnabled" | "setTfliteInferencingEnabled" | "tfliteInference" | "isWifiAvailable" | "getWifiSSID" | "setWifiSSID" | "getWifiPassword" | "setWifiPassword" | "getWifiConnectionEnabled" | "setWifiConnectionEnabled" | "isWifiConnected" | "ipAddress" | "isWifiSecure" | "cameraStatus" | "cameraCommand" | "getCameraConfiguration" | "setCameraConfiguration" | "cameraData" | "microphoneStatus" | "microphoneCommand" | "getMicrophoneConfiguration" | "setMicrophoneConfiguration" | "microphoneData" | "isDisplayAvailable" | "displayStatus" | "displayInformation" | "displayCommand" | "getDisplayBrightness" | "setDisplayBrightness" | "displayContextCommands" | "displayReady" | "getDisplaySpriteSheetName" | "setDisplaySpriteSheetName" | "displaySpriteSheetIndex" | "getSensorCounts" | "getLedInformation" | "setLeds" | "clearLeds" | "deviceInformation" | "notConnected" | "isConnected" | "barometer" | "acceleration" | "gravity" | "linearAcceleration" | "gyroscope" | "magnetometer" | "gameRotation" | "rotation" | "orientation" | "stepDetector" | "stepCounter" | "activity" | "deviceOrientation" | "tapDetector" | "pressure" | "buttons" | "touches" | "light" | "connectionMessage" | "connectionStatus" | "pressureAutoRangeEnabled" | "pressureAutoRangeDisabled" | "pressureAutoRange" | "pressureMotionAutoRangeEnabled" | "pressureMotionAutoRangeDisabled" | "pressureMotionAutoRange" | "isRecordingPressureCalibrationData" | "pressureCalibrationDataRecordStart" | "pressureCalibrationDataRecordStop" | "pressureCalibrationDataRecordingProgress" | "isTrainingPressureCalibration" | "pressureCalibrationTrainStart" | "pressureCalibrationTrainEnd" | "pressureCalibrationTrainProgress" | "calibratedPressureModel" | "numberOfButtons" | "button" | "buttonDown" | "buttonUp" | "numberOfTouches" | "touch" | "touchDown" | "touchUp" | "fileTransferProgress" | "fileTransferComplete" | "fileReceived" | "fileSent" | "cameraImageProgress" | "cameraImage" | "isRecordingCamera" | "cameraRecording" | "autoPicture" | "startRecordingCamera" | "stopRecordingCamera" | "isRecordingMicrophone" | "microphoneRecording" | "startRecordingMicrophone" | "stopRecordingMicrophone" | "displayContextState" | "displayColor" | "displayColorOpacity" | "displayOpacity" | "displaySpriteSheetUploadStart" | "displaySpriteSheetUploadProgress" | "displaySpriteSheetUploadComplete" | "setLed" | "firmwareImages" | "firmwareUploadProgress" | "firmwareStatus" | "camera" | "microphone" | "firmwareUploadComplete">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<Device, "manufacturerName" | "modelNumber" | "hardwareRevision" | "firmwareRevision" | "softwareRevision" | "pnpId" | "serialNumber" | "batteryLevel" | "rx" | "tx" | "smp" | "connecting" | "connected" | "disconnecting" | "isCharging" | "getBatteryCurrent" | "getMtu" | "getId" | "getName" | "setName" | "getType" | "setType" | "getCurrentTime" | "setCurrentTime" | "getSensorConfiguration" | "setSensorConfiguration" | "getPressurePositions" | "getSensorScalars" | "sensorData" | "getVibrationLocations" | "triggerVibration" | "getFileTypes" | "maxFileLength" | "getFileType" | "setFileType" | "getFileLength" | "setFileLength" | "getFileChecksum" | "setFileChecksum" | "setFileTransferCommand" | "fileTransferStatus" | "getFileBlock" | "setFileBlock" | "fileBytesTransferred" | "getTfliteName" | "setTfliteName" | "getTfliteTask" | "setTfliteTask" | "getTfliteSampleRate" | "setTfliteSampleRate" | "getTfliteSensorTypes" | "setTfliteSensorTypes" | "tfliteIsReady" | "getTfliteCaptureDelay" | "setTfliteCaptureDelay" | "getTfliteThreshold" | "setTfliteThreshold" | "getTfliteInferencingEnabled" | "setTfliteInferencingEnabled" | "tfliteInference" | "isWifiAvailable" | "getWifiSSID" | "setWifiSSID" | "getWifiPassword" | "setWifiPassword" | "getWifiConnectionEnabled" | "setWifiConnectionEnabled" | "isWifiConnected" | "ipAddress" | "isWifiSecure" | "cameraStatus" | "cameraCommand" | "getCameraConfiguration" | "setCameraConfiguration" | "cameraData" | "microphoneStatus" | "microphoneCommand" | "getMicrophoneConfiguration" | "setMicrophoneConfiguration" | "microphoneData" | "isDisplayAvailable" | "displayStatus" | "displayInformation" | "displayCommand" | "getDisplayBrightness" | "setDisplayBrightness" | "displayContextCommands" | "displayReady" | "getDisplaySpriteSheetName" | "setDisplaySpriteSheetName" | "displaySpriteSheetIndex" | "getSensorCounts" | "getLedInformation" | "setLeds" | "clearLeds" | "deviceInformation" | "notConnected" | "isConnected" | "barometer" | "acceleration" | "gravity" | "linearAcceleration" | "gyroscope" | "magnetometer" | "gameRotation" | "rotation" | "orientation" | "stepDetector" | "stepCounter" | "activity" | "deviceOrientation" | "tapDetector" | "pressure" | "buttons" | "touches" | "light" | "connectionMessage" | "connectionStatus" | "pressureAutoRangeEnabled" | "pressureAutoRangeDisabled" | "pressureAutoRange" | "pressureMotionAutoRangeEnabled" | "pressureMotionAutoRangeDisabled" | "pressureMotionAutoRange" | "isRecordingPressureCalibrationData" | "pressureCalibrationDataRecordStart" | "pressureCalibrationDataRecordStop" | "pressureCalibrationDataRecordingProgress" | "isTrainingPressureCalibration" | "pressureCalibrationTrainStart" | "pressureCalibrationTrainEnd" | "pressureCalibrationTrainProgress" | "calibratedPressureModel" | "numberOfButtons" | "button" | "buttonDown" | "buttonUp" | "numberOfTouches" | "touch" | "touchDown" | "touchUp" | "fileTransferProgress" | "fileTransferComplete" | "fileReceived" | "fileSent" | "cameraImageProgress" | "cameraImage" | "isRecordingCamera" | "cameraRecording" | "autoPicture" | "startRecordingCamera" | "stopRecordingCamera" | "isRecordingMicrophone" | "microphoneRecording" | "startRecordingMicrophone" | "stopRecordingMicrophone" | "displayContextState" | "displayColor" | "displayColorOpacity" | "displayOpacity" | "displaySpriteSheetUploadStart" | "displaySpriteSheetUploadProgress" | "displaySpriteSheetUploadComplete" | "setLed" | "firmwareImages" | "firmwareUploadProgress" | "firmwareStatus" | "camera" | "microphone" | "firmwareUploadComplete", DeviceEventMessages, T>>;
    get removeEventListeners(): <T extends "manufacturerName" | "modelNumber" | "hardwareRevision" | "firmwareRevision" | "softwareRevision" | "pnpId" | "serialNumber" | "batteryLevel" | "rx" | "tx" | "smp" | "connecting" | "connected" | "disconnecting" | "isCharging" | "getBatteryCurrent" | "getMtu" | "getId" | "getName" | "setName" | "getType" | "setType" | "getCurrentTime" | "setCurrentTime" | "getSensorConfiguration" | "setSensorConfiguration" | "getPressurePositions" | "getSensorScalars" | "sensorData" | "getVibrationLocations" | "triggerVibration" | "getFileTypes" | "maxFileLength" | "getFileType" | "setFileType" | "getFileLength" | "setFileLength" | "getFileChecksum" | "setFileChecksum" | "setFileTransferCommand" | "fileTransferStatus" | "getFileBlock" | "setFileBlock" | "fileBytesTransferred" | "getTfliteName" | "setTfliteName" | "getTfliteTask" | "setTfliteTask" | "getTfliteSampleRate" | "setTfliteSampleRate" | "getTfliteSensorTypes" | "setTfliteSensorTypes" | "tfliteIsReady" | "getTfliteCaptureDelay" | "setTfliteCaptureDelay" | "getTfliteThreshold" | "setTfliteThreshold" | "getTfliteInferencingEnabled" | "setTfliteInferencingEnabled" | "tfliteInference" | "isWifiAvailable" | "getWifiSSID" | "setWifiSSID" | "getWifiPassword" | "setWifiPassword" | "getWifiConnectionEnabled" | "setWifiConnectionEnabled" | "isWifiConnected" | "ipAddress" | "isWifiSecure" | "cameraStatus" | "cameraCommand" | "getCameraConfiguration" | "setCameraConfiguration" | "cameraData" | "microphoneStatus" | "microphoneCommand" | "getMicrophoneConfiguration" | "setMicrophoneConfiguration" | "microphoneData" | "isDisplayAvailable" | "displayStatus" | "displayInformation" | "displayCommand" | "getDisplayBrightness" | "setDisplayBrightness" | "displayContextCommands" | "displayReady" | "getDisplaySpriteSheetName" | "setDisplaySpriteSheetName" | "displaySpriteSheetIndex" | "getSensorCounts" | "getLedInformation" | "setLeds" | "clearLeds" | "deviceInformation" | "notConnected" | "isConnected" | "barometer" | "acceleration" | "gravity" | "linearAcceleration" | "gyroscope" | "magnetometer" | "gameRotation" | "rotation" | "orientation" | "stepDetector" | "stepCounter" | "activity" | "deviceOrientation" | "tapDetector" | "pressure" | "buttons" | "touches" | "light" | "connectionMessage" | "connectionStatus" | "pressureAutoRangeEnabled" | "pressureAutoRangeDisabled" | "pressureAutoRange" | "pressureMotionAutoRangeEnabled" | "pressureMotionAutoRangeDisabled" | "pressureMotionAutoRange" | "isRecordingPressureCalibrationData" | "pressureCalibrationDataRecordStart" | "pressureCalibrationDataRecordStop" | "pressureCalibrationDataRecordingProgress" | "isTrainingPressureCalibration" | "pressureCalibrationTrainStart" | "pressureCalibrationTrainEnd" | "pressureCalibrationTrainProgress" | "calibratedPressureModel" | "numberOfButtons" | "button" | "buttonDown" | "buttonUp" | "numberOfTouches" | "touch" | "touchDown" | "touchUp" | "fileTransferProgress" | "fileTransferComplete" | "fileReceived" | "fileSent" | "cameraImageProgress" | "cameraImage" | "isRecordingCamera" | "cameraRecording" | "autoPicture" | "startRecordingCamera" | "stopRecordingCamera" | "isRecordingMicrophone" | "microphoneRecording" | "startRecordingMicrophone" | "stopRecordingMicrophone" | "displayContextState" | "displayColor" | "displayColorOpacity" | "displayOpacity" | "displaySpriteSheetUploadStart" | "displaySpriteSheetUploadProgress" | "displaySpriteSheetUploadComplete" | "setLed" | "firmwareImages" | "firmwareUploadProgress" | "firmwareStatus" | "camera" | "microphone" | "firmwareUploadComplete" | "*">(type: T) => void;
    removeAllEventListeners(): void;
    ...
    get connectionType(): "bluetooth" | "none" | "client" | "webSocket" | "udp";
    ...
    get continuousSensorTypes(): ("barometer" | "acceleration" | "gravity" | "linearAcceleration" | "gyroscope" | "magnetometer" | "gameRotation" | "rotation" | "orientation" | "pressure" | "light")[];
    ...
    get tfliteSensorTypes(): ("linearAcceleration" | "gyroscope" | "magnetometer" | "pressure" | "camera" | "microphone")[];
    ...
    get setDisplayBrightness(): (newDisplayBrightness: DisplayBrightness, sendImmediately?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get pendingDisplaySpriteSheetName(): string | undefined;
    get parseDisplaySpriteSheet(): (dataView: DataView<ArrayBuffer>, name?: string, includesHeader?: boolean, displayCanvasHelper?: undefined) => DisplaySpriteSheet;
    get displayInformation(): DisplayInformation;
    ...
    get isDisplayAwake(): boolean;
    get showDisplay(): (sendImmediately?: boolean, waitUntilReady?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get clearDisplay(): (sendImmediately?: boolean, waitUntilReady?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplayColor(): (colorIndex: number, color: DisplayColorRGBOrString, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplayColorOpacity(): (colorIndex: number, opacity: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplayOpacity(): (opacity: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get saveDisplayContext(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get restoreDisplayContext(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get clearDisplayRect(): (x: number, y: number, width: number, height: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get selectDisplayBackgroundColor(): (backgroundColorIndex: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get selectDisplayFillColor(): (fillColorIndex: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get selectDisplayLineColor(): (lineColorIndex: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplayIgnoreFill(): (ignoreFill: boolean, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplayIgnoreLine(): (ignoreLine: boolean, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplayFillBackground(): (fillBackground: boolean, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplayLineWidth(): (lineWidth: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplayRotation(): (rotation: number, isRadians?: boolean, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get clearDisplayRotation(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplaySegmentStartCap(): (segmentStartCap: DisplaySegmentCap, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplaySegmentEndCap(): (segmentEndCap: DisplaySegmentCap, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplaySegmentCap(): (segmentCap: DisplaySegmentCap, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplaySegmentStartRadius(): (segmentStartRadius: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplaySegmentEndRadius(): (segmentEndRadius: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplaySegmentRadius(): (segmentRadius: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    ...
    get setDisplayCrop(): (cropDirection: DisplayCropDirection, crop: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get clearDisplayCrop(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get clearDisplayContext(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplayRotationCropTop(): (rotationCropTop: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    ...
    get setDisplayRotationCrop(): (cropDirection: DisplayCropDirection, crop: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get clearDisplayRotationCrop(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get flushDisplayContextCommands(): (isSending?: boolean) => Promise<void>;
    get drawDisplayRect(): (offsetX: number, offsetY: number, width: number, height: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayCircle(): (offsetX: number, offsetY: number, radius: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayEllipse(): (offsetX: number, offsetY: number, radiusX: number, radiusY: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayRoundRect(): (offsetX: number, offsetY: number, width: number, height: number, borderRadius: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayRegularPolygon(): (offsetX: number, offsetY: number, radius: number, numberOfSides: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayPolygon(): (points: Vector2[], sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayWireframe(): (wireframe: DisplayWireframe, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplaySegment(): (startX: number, startY: number, endX: number, endY: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplaySegments(): (points: Vector2[], sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayArc(): (offsetX: number, offsetY: number, radius: number, startAngle: number, angleOffset: number, isRadians?: boolean, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayArcEllipse(): (offsetX: number, offsetY: number, radiusX: number, radiusY: number, startAngle: number, angleOffset: number, isRadians?: boolean, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayBitmap(): (offsetX: number, offsetY: number, bitmap: DisplayBitmap, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    ...
    get setDisplayContextState(): (newState: PartialDisplayContextState, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get selectDisplayBitmapColor(): (bitmapColorIndex: number, colorIndex: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get selectDisplayBitmapColors(): (bitmapColorPairs: DisplayBitmapColorPair[], sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    ...
    get setDisplayBitmapScaleDirection(): (direction: DisplayScaleDirection, bitmapScale: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    ...
    get resetDisplayBitmapScale(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get selectDisplaySpriteColor(): (spriteColorIndex: number, colorIndex: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get selectDisplaySpriteColors(): (spriteColorPairs: DisplaySpriteColorPair[], sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    ...
    get resetDisplaySpriteColors(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get setDisplaySpriteScaleDirection(): (direction: DisplayScaleDirection, spriteScale: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    ...
    get resetDisplaySpriteScale(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get displayManager(): DisplayManager;
    get uploadDisplaySpriteSheet(): (spriteSheet: DisplaySpriteSheet, displayCanvasHelper?: undefined) => Promise<void>;
    get uploadDisplaySpriteSheets(): (spriteSheets: DisplaySpriteSheet[]) => Promise<void>;
    get selectDisplaySpriteSheet(): (spriteSheetName: string, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplaySprite(): (offsetX: number, offsetY: number, spriteName: string, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get startDisplaySprite(): (offsetX: number, offsetY: number, width: number, height: number, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get endDisplaySprite(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get displaySpriteSheets(): Record<string, DisplaySpriteSheet>;
    get serializeDisplaySpriteSheet(): (spriteSheet: DisplaySpriteSheet, includeHeader?: boolean, displayCanvasHelper?: undefined) => ArrayBuffer;
    get setDisplayAlignment(): (alignmentDirection: DisplayAlignmentDirection, alignment: DisplayAlignment, sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    ...
    get resetDisplayAlignment(): (sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    ...
    get drawDisplayQuadraticBezierCurve(): (controlPoints: Vector2[], sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayQuadraticBezierCurves(): (controlPoints: Vector2[], sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayCubicBezierCurve(): (controlPoints: Vector2[], sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayCubicBezierCurves(): (controlPoints: Vector2[], sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayPath(): (curves: DisplayBezierCurve[], sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get drawDisplayClosedPath(): (curves: DisplayBezierCurve[], sendImmediately?: boolean, isSending?: boolean, displayCanvasHelper?: undefined) => Promise<void>;
    get leds(): Led[];
    get hasLeds(): boolean;
...
declare const DeviceManagerEventTypes: readonly [...("deviceOrientation" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus")[], "availableDevice", "unavailableDevice", "availableDevices", "connectedDevices", "device*"];
...
declare class DeviceManager {
    ...
    constructor();
    private _onDevice;
    _onDeviceConnectionStatusUpdated(device: Device, connectionStatus: ConnectionStatus): void;
    ...
    getAvailableDeviceByBluetoothId(bluetoothId: string, connectionType?: ConnectionType): Device | undefined;
    ...
    get addEventListener(): <T extends "deviceOrientation" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "availableDevice" | "unavailableDevice" | "availableDevices" | "connectedDevices" | "*">(type: T, listener: (event: ListenerEvent<DeviceManager, "deviceOrientation" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "availableDevice" | "unavailableDevice" | "availableDevices" | "connectedDevices", DeviceManagerEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "deviceOrientation" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "availableDevice" | "unavailableDevice" | "availableDevices" | "connectedDevices" | "*">(type: T, listener: (event: ListenerEvent<DeviceManager, "deviceOrientation" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "availableDevice" | "unavailableDevice" | "availableDevices" | "connectedDevices", DeviceManagerEventMessages, T>) => void) => void;
    get removeEventListeners(): <T extends "deviceOrientation" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "availableDevice" | "unavailableDevice" | "availableDevices" | "connectedDevices" | "*">(type: T) => void;
    get waitForEvent(): <T extends "deviceOrientation" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "availableDevice" | "unavailableDevice" | "availableDevices" | "connectedDevices">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<DeviceManager, "deviceOrientation" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "availableDevice" | "unavailableDevice" | "availableDevices" | "connectedDevices", DeviceManagerEventMessages, T>>;
...
declare const ServerEventTypes: readonly ["clientConnected", "clientNotConnected"];
...
declare abstract class BaseServer<ServerClient extends BaseServerClient> {
    ...
    get addEventListener(): <T extends "*" | "clientConnected" | "clientNotConnected">(type: T, listener: (event: ListenerEvent<BaseServer<ServerClient>, "clientConnected" | "clientNotConnected", BaseServerEventMessages<ServerClient>, T>) => void, options?: EventDispatcherOptions) => void;
    ...
    get removeEventListener(): <T extends "*" | "clientConnected" | "clientNotConnected">(type: T, listener: (event: ListenerEvent<BaseServer<ServerClient>, "clientConnected" | "clientNotConnected", BaseServerEventMessages<ServerClient>, T>) => void) => void;
    get waitForEvent(): <T extends "clientConnected" | "clientNotConnected">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<BaseServer<ServerClient>, "clientConnected" | "clientNotConnected", BaseServerEventMessages<ServerClient>, T>>;
...
declare class UDPServer extends BaseServer<UDPServerClient> {
    ...
    get socket(): dgram.Socket | undefined;
    set socket(newSocket: dgram.Socket | undefined);
    _sendToClient(client: UDPServerClient, arrayBuffer: ArrayBuffer, isWrapped?: boolean): boolean;
}
...
type GuardManagerOptions = {
    signal?: AbortSignal;
};
declare const DefaultGuardManagerOptions: GuardManagerOptions;
type GuardManagerObject<TArgs extends unknown[]> = {
    guard: Guard<TArgs>;
...
interface BaseServerClientDeviceVibrationConfigurationGuardManagerArg {
    device: Device;
    client: ServerClient;
    vibrationConfiguration: VibrationConfiguration;
    server: Server;
}
interface BaseServerClientDeviceFileGuardManagerArg {
    device: Device;
    client: ServerClient;
    fileConfiguration: ExtendedFileConfiguration;
    server: Server;
...
declare class ServerManager {
    ...
    get addEventListener(): <T extends "*" | "server" | "serverClientConnected" | "serverClientNotConnected" | "servers" | "server*">(type: T, listener: (event: ListenerEvent<ServerManager, "server" | "serverClientConnected" | "serverClientNotConnected" | "servers" | "server*", ServerManagerEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "*" | "server" | "serverClientConnected" | "serverClientNotConnected" | "servers" | "server*">(type: T, listener: (event: ListenerEvent<ServerManager, "server" | "serverClientConnected" | "serverClientNotConnected" | "servers" | "server*", ServerManagerEventMessages, T>) => void) => void;
...
declare const ClientEventTypes: readonly ["notConnected", "connecting", "connected", "disconnecting", "connectionStatus", "isConnected", "isScanningAvailable", "isScanning", "discoveredDevice", "discoveredDeviceUpdate", "expiredDiscoveredDevice", "discoveredDevices", "scanningAvailable", "scanningNotAvailable", "scanning", "notScanning"];
...
declare class ClientManager {
    ...
    constructor();
    get clients(): Client[];
    get addEventListener(): <T extends "client" | "*" | "clientConnected" | "clientNotConnected" | "clients" | "clientConnecting" | "clientDisconnecting" | "clientIsConnected" | "clientConnectionStatus" | "clientIsScanningAvailable" | "clientIsScanning" | "clientDiscoveredDevice" | "clientDiscoveredDeviceUpdate" | "clientExpiredDiscoveredDevice" | "clientDiscoveredDevices" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientScanning" | "clientNotScanning" | "client*">(type: T, listener: (event: ListenerEvent<ClientManager, "client" | "clientConnected" | "clientNotConnected" | "clients" | "clientConnecting" | "clientDisconnecting" | "clientIsConnected" | "clientConnectionStatus" | "clientIsScanningAvailable" | "clientIsScanning" | "clientDiscoveredDevice" | "clientDiscoveredDeviceUpdate" | "clientExpiredDiscoveredDevice" | "clientDiscoveredDevices" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientScanning" | "clientNotScanning" | "client*", ClientManagerEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "client" | "*" | "clientConnected" | "clientNotConnected" | "clients" | "clientConnecting" | "clientDisconnecting" | "clientIsConnected" | "clientConnectionStatus" | "clientIsScanningAvailable" | "clientIsScanning" | "clientDiscoveredDevice" | "clientDiscoveredDeviceUpdate" | "clientExpiredDiscoveredDevice" | "clientDiscoveredDevices" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientScanning" | "clientNotScanning" | "client*">(type: T, listener: (event: ListenerEvent<ClientManager, "client" | "clientConnected" | "clientNotConnected" | "clients" | "clientConnecting" | "clientDisconnecting" | "clientIsConnected" | "clientConnectionStatus" | "clientIsScanningAvailable" | "clientIsScanning" | "clientDiscoveredDevice" | "clientDiscoveredDeviceUpdate" | "clientExpiredDiscoveredDevice" | "clientDiscoveredDevices" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientScanning" | "clientNotScanning" | "client*", ClientManagerEventMessages, T>) => void) => void;
    get removeEventListeners(): <T extends "client" | "*" | "clientConnected" | "clientNotConnected" | "clients" | "clientConnecting" | "clientDisconnecting" | "clientIsConnected" | "clientConnectionStatus" | "clientIsScanningAvailable" | "clientIsScanning" | "clientDiscoveredDevice" | "clientDiscoveredDeviceUpdate" | "clientExpiredDiscoveredDevice" | "clientDiscoveredDevices" | "clientScanningAvailable" | "clientScanningNotAvailable" | "clientScanning" | "clientNotScanning" | "client*">(type: T) => void;
}
declare const _default$2: ClientManager;

type PubSubPeer = ServerClient | Client;
...
type PubSubPeerOrType = PubSubPeer | ServerType;
type BasePubSubManagerOptions = {
...
declare class PubSubManager {
    ...
    get removeEventListener(): <T extends "*" | "peerConnected" | "peerNotConnected" | "subscribed" | "unsubscribed" | "peerSubscribed" | "peerUnsubscribed" | "published" | "peerPublished">(type: T, listener: (event: ListenerEvent<PubSubManager, "peerConnected" | "peerNotConnected" | "subscribed" | "unsubscribed" | "peerSubscribed" | "peerUnsubscribed" | "published" | "peerPublished", PubSubManagerEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "peerConnected" | "peerNotConnected" | "subscribed" | "unsubscribed" | "peerSubscribed" | "peerUnsubscribed" | "published" | "peerPublished">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<PubSubManager, "peerConnected" | "peerNotConnected" | "subscribed" | "unsubscribed" | "peerSubscribed" | "peerUnsubscribed" | "published" | "peerPublished", PubSubManagerEventMessages, T>>;
...
declare const wildcardScannerEventType: "scanner*";
type WildcardScannerEventMessage<BaseMessage> = {
...
declare class ScannerManager {
    ...
    private _onScanner;
    get addEventListener(): <T extends "*" | "discoveredDevices" | "scanner" | "scannerIsScanningAvailable" | "scannerIsScanning" | "scannerDiscoveredDevice" | "scannerDiscoveredDeviceUpdate" | "scannerExpiredDiscoveredDevice" | "scannerDiscoveredDevices" | "scannerScanningAvailable" | "scannerScanningNotAvailable" | "scannerScanning" | "scannerNotScanning" | "scanners" | "scanner*">(type: T, listener: (event: ListenerEvent<ScannerManager, "discoveredDevices" | "scanner" | "scannerIsScanningAvailable" | "scannerIsScanning" | "scannerDiscoveredDevice" | "scannerDiscoveredDeviceUpdate" | "scannerExpiredDiscoveredDevice" | "scannerDiscoveredDevices" | "scannerScanningAvailable" | "scannerScanningNotAvailable" | "scannerScanning" | "scannerNotScanning" | "scanners" | "scanner*", ScannerManagerEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "*" | "discoveredDevices" | "scanner" | "scannerIsScanningAvailable" | "scannerIsScanning" | "scannerDiscoveredDevice" | "scannerDiscoveredDeviceUpdate" | "scannerExpiredDiscoveredDevice" | "scannerDiscoveredDevices" | "scannerScanningAvailable" | "scannerScanningNotAvailable" | "scannerScanning" | "scannerNotScanning" | "scanners" | "scanner*">(type: T, listener: (event: ListenerEvent<ScannerManager, "discoveredDevices" | "scanner" | "scannerIsScanningAvailable" | "scannerIsScanning" | "scannerDiscoveredDevice" | "scannerDiscoveredDeviceUpdate" | "scannerExpiredDiscoveredDevice" | "scannerDiscoveredDevices" | "scannerScanningAvailable" | "scannerScanningNotAvailable" | "scannerScanning" | "scannerNotScanning" | "scanners" | "scanner*", ScannerManagerEventMessages, T>) => void) => void;
    get removeEventListeners(): <T extends "*" | "discoveredDevices" | "scanner" | "scannerIsScanningAvailable" | "scannerIsScanning" | "scannerDiscoveredDevice" | "scannerDiscoveredDeviceUpdate" | "scannerExpiredDiscoveredDevice" | "scannerDiscoveredDevices" | "scannerScanningAvailable" | "scannerScanningNotAvailable" | "scannerScanning" | "scannerNotScanning" | "scanners" | "scanner*">(type: T) => void;
}
...
declare const DevicePairEventTypes: readonly ["isConnected", "device*", "pressure", "sensorData", ...("deviceOrientation" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "rightManufacturerName" | "rightModelNumber" | "rightHardwareRevision" | "rightFirmwareRevision" | "rightSoftwareRevision" | "rightPnpId" | "rightSerialNumber" | "rightBatteryLevel" | "rightSmp" | "rightConnecting" | "rightConnected" | "rightDisconnecting" | "rightIsCharging" | "rightGetBatteryCurrent" | "rightGetMtu" | "rightGetId" | "rightGetName" | "rightGetType" | "rightGetCurrentTime" | "rightGetSensorConfiguration" | "rightSensorData" | "rightGetFileTypes" | "rightMaxFileLength" | "rightGetFileType" | "rightGetFileLength" | "rightGetFileChecksum" | "rightFileTransferStatus" | "rightGetFileBlock" | "rightFileBytesTransferred" | "rightGetTfliteName" | "rightGetTfliteTask" | "rightGetTfliteSampleRate" | "rightGetTfliteSensorTypes" | "rightTfliteIsReady" | "rightGetTfliteCaptureDelay" | "rightGetTfliteThreshold" | "rightGetTfliteInferencingEnabled" | "rightTfliteInference" | "rightIsWifiAvailable" | "rightGetWifiSSID" | "rightGetWifiPassword" | "rightIsWifiConnected" | "rightIpAddress" | "rightCameraStatus" | "rightGetCameraConfiguration" | "rightMicrophoneStatus" | "rightGetMicrophoneConfiguration" | "rightMicrophoneData" | "rightIsDisplayAvailable" | "rightDisplayStatus" | "rightDisplayInformation" | "rightGetDisplayBrightness" | "rightDisplayContextCommands" | "rightDisplayReady" | "rightGetDisplaySpriteSheetName" | "rightGetLedInformation" | "rightDeviceInformation" | "rightNotConnected" | "rightIsConnected" | "rightBarometer" | "rightAcceleration" | "rightGravity" | "rightLinearAcceleration" | "rightGyroscope" | "rightMagnetometer" | "rightGameRotation" | "rightRotation" | "rightOrientation" | "rightStepDetector" | "rightStepCounter" | "rightActivity" | "rightDeviceOrientation" | "rightTapDetector" | "rightPressure" | "rightButtons" | "rightTouches" | "rightLight" | "rightConnectionMessage" | "rightConnectionStatus" | "rightIsLast" | "rightPressureAutoRangeEnabled" | "rightPressureAutoRangeDisabled" | "rightPressureAutoRange" | "rightPressureMotionAutoRangeEnabled" | "rightPressureMotionAutoRangeDisabled" | "rightPressureMotionAutoRange" | "rightIsRecordingPressureCalibrationData" | "rightPressureCalibrationDataRecordStart" | "rightPressureCalibrationDataRecordStop" | "rightPressureCalibrationDataRecordingProgress" | "rightIsTrainingPressureCalibration" | "rightPressureCalibrationTrainStart" | "rightPressureCalibrationTrainEnd" | "rightPressureCalibrationTrainProgress" | "rightCalibratedPressureModel" | "rightNumberOfButtons" | "rightButton" | "rightButtonDown" | "rightButtonUp" | "rightNumberOfTouches" | "rightTouch" | "rightTouchDown" | "rightTouchUp" | "rightFileTransferProgress" | "rightFileTransferComplete" | "rightFileReceived" | "rightFileSent" | "rightGetEnableWifiConnection" | "rightCameraImageProgress" | "rightCameraImage" | "rightIsRecordingCamera" | "rightCameraRecording" | "rightAutoPicture" | "rightStartRecordingCamera" | "rightStopRecordingCamera" | "rightIsRecordingMicrophone" | "rightMicrophoneRecording" | "rightStartRecordingMicrophone" | "rightStopRecordingMicrophone" | "rightDisplayContextState" | "rightDisplayColor" | "rightDisplayColorOpacity" | "rightDisplayOpacity" | "rightDisplaySpriteSheetUploadStart" | "rightDisplaySpriteSheetUploadProgress" | "rightDisplaySpriteSheetUploadComplete" | "rightSetLed" | "rightFirmwareImages" | "rightFirmwareUploadProgress" | "rightFirmwareStatus" | "leftManufacturerName" | "leftModelNumber" | "leftHardwareRevision" | "leftFirmwareRevision" | "leftSoftwareRevision" | "leftPnpId" | "leftSerialNumber" | "leftBatteryLevel" | "leftSmp" | "leftConnecting" | "leftConnected" | "leftDisconnecting" | "leftIsCharging" | "leftGetBatteryCurrent" | "leftGetMtu" | "leftGetId" | "leftGetName" | "leftGetType" | "leftGetCurrentTime" | "leftGetSensorConfiguration" | "leftSensorData" | "leftGetFileTypes" | "leftMaxFileLength" | "leftGetFileType" | "leftGetFileLength" | "leftGetFileChecksum" | "leftFileTransferStatus" | "leftGetFileBlock" | "leftFileBytesTransferred" | "leftGetTfliteName" | "leftGetTfliteTask" | "leftGetTfliteSampleRate" | "leftGetTfliteSensorTypes" | "leftTfliteIsReady" | "leftGetTfliteCaptureDelay" | "leftGetTfliteThreshold" | "leftGetTfliteInferencingEnabled" | "leftTfliteInference" | "leftIsWifiAvailable" | "leftGetWifiSSID" | "leftGetWifiPassword" | "leftIsWifiConnected" | "leftIpAddress" | "leftCameraStatus" | "leftGetCameraConfiguration" | "leftMicrophoneStatus" | "leftGetMicrophoneConfiguration" | "leftMicrophoneData" | "leftIsDisplayAvailable" | "leftDisplayStatus" | "leftDisplayInformation" | "leftGetDisplayBrightness" | "leftDisplayContextCommands" | "leftDisplayReady" | "leftGetDisplaySpriteSheetName" | "leftGetLedInformation" | "leftDeviceInformation" | "leftNotConnected" | "leftIsConnected" | "leftBarometer" | "leftAcceleration" | "leftGravity" | "leftLinearAcceleration" | "leftGyroscope" | "leftMagnetometer" | "leftGameRotation" | "leftRotation" | "leftOrientation" | "leftStepDetector" | "leftStepCounter" | "leftActivity" | "leftDeviceOrientation" | "leftTapDetector" | "leftPressure" | "leftButtons" | "leftTouches" | "leftLight" | "leftConnectionMessage" | "leftConnectionStatus" | "leftIsLast" | "leftPressureAutoRangeEnabled" | "leftPressureAutoRangeDisabled" | "leftPressureAutoRange" | "leftPressureMotionAutoRangeEnabled" | "leftPressureMotionAutoRangeDisabled" | "leftPressureMotionAutoRange" | "leftIsRecordingPressureCalibrationData" | "leftPressureCalibrationDataRecordStart" | "leftPressureCalibrationDataRecordStop" | "leftPressureCalibrationDataRecordingProgress" | "leftIsTrainingPressureCalibration" | "leftPressureCalibrationTrainStart" | "leftPressureCalibrationTrainEnd" | "leftPressureCalibrationTrainProgress" | "leftCalibratedPressureModel" | "leftNumberOfButtons" | "leftButton" | "leftButtonDown" | "leftButtonUp" | "leftNumberOfTouches" | "leftTouch" | "leftTouchDown" | "leftTouchUp" | "leftFileTransferProgress" | "leftFileTransferComplete" | "leftFileReceived" | "leftFileSent" | "leftGetEnableWifiConnection" | "leftCameraImageProgress" | "leftCameraImage" | "leftIsRecordingCamera" | "leftCameraRecording" | "leftAutoPicture" | "leftStartRecordingCamera" | "leftStopRecordingCamera" | "leftIsRecordingMicrophone" | "leftMicrophoneRecording" | "leftStartRecordingMicrophone" | "leftStopRecordingMicrophone" | "leftDisplayContextState" | "leftDisplayColor" | "leftDisplayColorOpacity" | "leftDisplayOpacity" | "leftDisplaySpriteSheetUploadStart" | "leftDisplaySpriteSheetUploadProgress" | "leftDisplaySpriteSheetUploadComplete" | "leftSetLed" | "leftFirmwareImages" | "leftFirmwareUploadProgress" | "leftFirmwareStatus")[]];
...
declare class DevicePair {
    ...
    get addEventListener(): <T extends "sensorData" | "isConnected" | "deviceOrientation" | "pressure" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "*" | "rightManufacturerName" | "rightModelNumber" | "rightHardwareRevision" | "rightFirmwareRevision" | "rightSoftwareRevision" | "rightPnpId" | "rightSerialNumber" | "rightBatteryLevel" | "rightSmp" | "rightConnecting" | "rightConnected" | "rightDisconnecting" | "rightIsCharging" | "rightGetBatteryCurrent" | "rightGetMtu" | "rightGetId" | "rightGetName" | "rightGetType" | "rightGetCurrentTime" | "rightGetSensorConfiguration" | "rightSensorData" | "rightGetFileTypes" | "rightMaxFileLength" | "rightGetFileType" | "rightGetFileLength" | "rightGetFileChecksum" | "rightFileTransferStatus" | "rightGetFileBlock" | "rightFileBytesTransferred" | "rightGetTfliteName" | "rightGetTfliteTask" | "rightGetTfliteSampleRate" | "rightGetTfliteSensorTypes" | "rightTfliteIsReady" | "rightGetTfliteCaptureDelay" | "rightGetTfliteThreshold" | "rightGetTfliteInferencingEnabled" | "rightTfliteInference" | "rightIsWifiAvailable" | "rightGetWifiSSID" | "rightGetWifiPassword" | "rightIsWifiConnected" | "rightIpAddress" | "rightCameraStatus" | "rightGetCameraConfiguration" | "rightMicrophoneStatus" | "rightGetMicrophoneConfiguration" | "rightMicrophoneData" | "rightIsDisplayAvailable" | "rightDisplayStatus" | "rightDisplayInformation" | "rightGetDisplayBrightness" | "rightDisplayContextCommands" | "rightDisplayReady" | "rightGetDisplaySpriteSheetName" | "rightGetLedInformation" | "rightDeviceInformation" | "rightNotConnected" | "rightIsConnected" | "rightBarometer" | "rightAcceleration" | "rightGravity" | "rightLinearAcceleration" | "rightGyroscope" | "rightMagnetometer" | "rightGameRotation" | "rightRotation" | "rightOrientation" | "rightStepDetector" | "rightStepCounter" | "rightActivity" | "rightDeviceOrientation" | "rightTapDetector" | "rightPressure" | "rightButtons" | "rightTouches" | "rightLight" | "rightConnectionMessage" | "rightConnectionStatus" | "rightIsLast" | "rightPressureAutoRangeEnabled" | "rightPressureAutoRangeDisabled" | "rightPressureAutoRange" | "rightPressureMotionAutoRangeEnabled" | "rightPressureMotionAutoRangeDisabled" | "rightPressureMotionAutoRange" | "rightIsRecordingPressureCalibrationData" | "rightPressureCalibrationDataRecordStart" | "rightPressureCalibrationDataRecordStop" | "rightPressureCalibrationDataRecordingProgress" | "rightIsTrainingPressureCalibration" | "rightPressureCalibrationTrainStart" | "rightPressureCalibrationTrainEnd" | "rightPressureCalibrationTrainProgress" | "rightCalibratedPressureModel" | "rightNumberOfButtons" | "rightButton" | "rightButtonDown" | "rightButtonUp" | "rightNumberOfTouches" | "rightTouch" | "rightTouchDown" | "rightTouchUp" | "rightFileTransferProgress" | "rightFileTransferComplete" | "rightFileReceived" | "rightFileSent" | "rightGetEnableWifiConnection" | "rightCameraImageProgress" | "rightCameraImage" | "rightIsRecordingCamera" | "rightCameraRecording" | "rightAutoPicture" | "rightStartRecordingCamera" | "rightStopRecordingCamera" | "rightIsRecordingMicrophone" | "rightMicrophoneRecording" | "rightStartRecordingMicrophone" | "rightStopRecordingMicrophone" | "rightDisplayContextState" | "rightDisplayColor" | "rightDisplayColorOpacity" | "rightDisplayOpacity" | "rightDisplaySpriteSheetUploadStart" | "rightDisplaySpriteSheetUploadProgress" | "rightDisplaySpriteSheetUploadComplete" | "rightSetLed" | "rightFirmwareImages" | "rightFirmwareUploadProgress" | "rightFirmwareStatus" | "leftManufacturerName" | "leftModelNumber" | "leftHardwareRevision" | "leftFirmwareRevision" | "leftSoftwareRevision" | "leftPnpId" | "leftSerialNumber" | "leftBatteryLevel" | "leftSmp" | "leftConnecting" | "leftConnected" | "leftDisconnecting" | "leftIsCharging" | "leftGetBatteryCurrent" | "leftGetMtu" | "leftGetId" | "leftGetName" | "leftGetType" | "leftGetCurrentTime" | "leftGetSensorConfiguration" | "leftSensorData" | "leftGetFileTypes" | "leftMaxFileLength" | "leftGetFileType" | "leftGetFileLength" | "leftGetFileChecksum" | "leftFileTransferStatus" | "leftGetFileBlock" | "leftFileBytesTransferred" | "leftGetTfliteName" | "leftGetTfliteTask" | "leftGetTfliteSampleRate" | "leftGetTfliteSensorTypes" | "leftTfliteIsReady" | "leftGetTfliteCaptureDelay" | "leftGetTfliteThreshold" | "leftGetTfliteInferencingEnabled" | "leftTfliteInference" | "leftIsWifiAvailable" | "leftGetWifiSSID" | "leftGetWifiPassword" | "leftIsWifiConnected" | "leftIpAddress" | "leftCameraStatus" | "leftGetCameraConfiguration" | "leftMicrophoneStatus" | "leftGetMicrophoneConfiguration" | "leftMicrophoneData" | "leftIsDisplayAvailable" | "leftDisplayStatus" | "leftDisplayInformation" | "leftGetDisplayBrightness" | "leftDisplayContextCommands" | "leftDisplayReady" | "leftGetDisplaySpriteSheetName" | "leftGetLedInformation" | "leftDeviceInformation" | "leftNotConnected" | "leftIsConnected" | "leftBarometer" | "leftAcceleration" | "leftGravity" | "leftLinearAcceleration" | "leftGyroscope" | "leftMagnetometer" | "leftGameRotation" | "leftRotation" | "leftOrientation" | "leftStepDetector" | "leftStepCounter" | "leftActivity" | "leftDeviceOrientation" | "leftTapDetector" | "leftPressure" | "leftButtons" | "leftTouches" | "leftLight" | "leftConnectionMessage" | "leftConnectionStatus" | "leftIsLast" | "leftPressureAutoRangeEnabled" | "leftPressureAutoRangeDisabled" | "leftPressureAutoRange" | "leftPressureMotionAutoRangeEnabled" | "leftPressureMotionAutoRangeDisabled" | "leftPressureMotionAutoRange" | "leftIsRecordingPressureCalibrationData" | "leftPressureCalibrationDataRecordStart" | "leftPressureCalibrationDataRecordStop" | "leftPressureCalibrationDataRecordingProgress" | "leftIsTrainingPressureCalibration" | "leftPressureCalibrationTrainStart" | "leftPressureCalibrationTrainEnd" | "leftPressureCalibrationTrainProgress" | "leftCalibratedPressureModel" | "leftNumberOfButtons" | "leftButton" | "leftButtonDown" | "leftButtonUp" | "leftNumberOfTouches" | "leftTouch" | "leftTouchDown" | "leftTouchUp" | "leftFileTransferProgress" | "leftFileTransferComplete" | "leftFileReceived" | "leftFileSent" | "leftGetEnableWifiConnection" | "leftCameraImageProgress" | "leftCameraImage" | "leftIsRecordingCamera" | "leftCameraRecording" | "leftAutoPicture" | "leftStartRecordingCamera" | "leftStopRecordingCamera" | "leftIsRecordingMicrophone" | "leftMicrophoneRecording" | "leftStartRecordingMicrophone" | "leftStopRecordingMicrophone" | "leftDisplayContextState" | "leftDisplayColor" | "leftDisplayColorOpacity" | "leftDisplayOpacity" | "leftDisplaySpriteSheetUploadStart" | "leftDisplaySpriteSheetUploadProgress" | "leftDisplaySpriteSheetUploadComplete" | "leftSetLed" | "leftFirmwareImages" | "leftFirmwareUploadProgress" | "leftFirmwareStatus">(type: T, listener: (event: ListenerEvent<DevicePair, "sensorData" | "isConnected" | "deviceOrientation" | "pressure" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "rightManufacturerName" | "rightModelNumber" | "rightHardwareRevision" | "rightFirmwareRevision" | "rightSoftwareRevision" | "rightPnpId" | "rightSerialNumber" | "rightBatteryLevel" | "rightSmp" | "rightConnecting" | "rightConnected" | "rightDisconnecting" | "rightIsCharging" | "rightGetBatteryCurrent" | "rightGetMtu" | "rightGetId" | "rightGetName" | "rightGetType" | "rightGetCurrentTime" | "rightGetSensorConfiguration" | "rightSensorData" | "rightGetFileTypes" | "rightMaxFileLength" | "rightGetFileType" | "rightGetFileLength" | "rightGetFileChecksum" | "rightFileTransferStatus" | "rightGetFileBlock" | "rightFileBytesTransferred" | "rightGetTfliteName" | "rightGetTfliteTask" | "rightGetTfliteSampleRate" | "rightGetTfliteSensorTypes" | "rightTfliteIsReady" | "rightGetTfliteCaptureDelay" | "rightGetTfliteThreshold" | "rightGetTfliteInferencingEnabled" | "rightTfliteInference" | "rightIsWifiAvailable" | "rightGetWifiSSID" | "rightGetWifiPassword" | "rightIsWifiConnected" | "rightIpAddress" | "rightCameraStatus" | "rightGetCameraConfiguration" | "rightMicrophoneStatus" | "rightGetMicrophoneConfiguration" | "rightMicrophoneData" | "rightIsDisplayAvailable" | "rightDisplayStatus" | "rightDisplayInformation" | "rightGetDisplayBrightness" | "rightDisplayContextCommands" | "rightDisplayReady" | "rightGetDisplaySpriteSheetName" | "rightGetLedInformation" | "rightDeviceInformation" | "rightNotConnected" | "rightIsConnected" | "rightBarometer" | "rightAcceleration" | "rightGravity" | "rightLinearAcceleration" | "rightGyroscope" | "rightMagnetometer" | "rightGameRotation" | "rightRotation" | "rightOrientation" | "rightStepDetector" | "rightStepCounter" | "rightActivity" | "rightDeviceOrientation" | "rightTapDetector" | "rightPressure" | "rightButtons" | "rightTouches" | "rightLight" | "rightConnectionMessage" | "rightConnectionStatus" | "rightIsLast" | "rightPressureAutoRangeEnabled" | "rightPressureAutoRangeDisabled" | "rightPressureAutoRange" | "rightPressureMotionAutoRangeEnabled" | "rightPressureMotionAutoRangeDisabled" | "rightPressureMotionAutoRange" | "rightIsRecordingPressureCalibrationData" | "rightPressureCalibrationDataRecordStart" | "rightPressureCalibrationDataRecordStop" | "rightPressureCalibrationDataRecordingProgress" | "rightIsTrainingPressureCalibration" | "rightPressureCalibrationTrainStart" | "rightPressureCalibrationTrainEnd" | "rightPressureCalibrationTrainProgress" | "rightCalibratedPressureModel" | "rightNumberOfButtons" | "rightButton" | "rightButtonDown" | "rightButtonUp" | "rightNumberOfTouches" | "rightTouch" | "rightTouchDown" | "rightTouchUp" | "rightFileTransferProgress" | "rightFileTransferComplete" | "rightFileReceived" | "rightFileSent" | "rightGetEnableWifiConnection" | "rightCameraImageProgress" | "rightCameraImage" | "rightIsRecordingCamera" | "rightCameraRecording" | "rightAutoPicture" | "rightStartRecordingCamera" | "rightStopRecordingCamera" | "rightIsRecordingMicrophone" | "rightMicrophoneRecording" | "rightStartRecordingMicrophone" | "rightStopRecordingMicrophone" | "rightDisplayContextState" | "rightDisplayColor" | "rightDisplayColorOpacity" | "rightDisplayOpacity" | "rightDisplaySpriteSheetUploadStart" | "rightDisplaySpriteSheetUploadProgress" | "rightDisplaySpriteSheetUploadComplete" | "rightSetLed" | "rightFirmwareImages" | "rightFirmwareUploadProgress" | "rightFirmwareStatus" | "leftManufacturerName" | "leftModelNumber" | "leftHardwareRevision" | "leftFirmwareRevision" | "leftSoftwareRevision" | "leftPnpId" | "leftSerialNumber" | "leftBatteryLevel" | "leftSmp" | "leftConnecting" | "leftConnected" | "leftDisconnecting" | "leftIsCharging" | "leftGetBatteryCurrent" | "leftGetMtu" | "leftGetId" | "leftGetName" | "leftGetType" | "leftGetCurrentTime" | "leftGetSensorConfiguration" | "leftSensorData" | "leftGetFileTypes" | "leftMaxFileLength" | "leftGetFileType" | "leftGetFileLength" | "leftGetFileChecksum" | "leftFileTransferStatus" | "leftGetFileBlock" | "leftFileBytesTransferred" | "leftGetTfliteName" | "leftGetTfliteTask" | "leftGetTfliteSampleRate" | "leftGetTfliteSensorTypes" | "leftTfliteIsReady" | "leftGetTfliteCaptureDelay" | "leftGetTfliteThreshold" | "leftGetTfliteInferencingEnabled" | "leftTfliteInference" | "leftIsWifiAvailable" | "leftGetWifiSSID" | "leftGetWifiPassword" | "leftIsWifiConnected" | "leftIpAddress" | "leftCameraStatus" | "leftGetCameraConfiguration" | "leftMicrophoneStatus" | "leftGetMicrophoneConfiguration" | "leftMicrophoneData" | "leftIsDisplayAvailable" | "leftDisplayStatus" | "leftDisplayInformation" | "leftGetDisplayBrightness" | "leftDisplayContextCommands" | "leftDisplayReady" | "leftGetDisplaySpriteSheetName" | "leftGetLedInformation" | "leftDeviceInformation" | "leftNotConnected" | "leftIsConnected" | "leftBarometer" | "leftAcceleration" | "leftGravity" | "leftLinearAcceleration" | "leftGyroscope" | "leftMagnetometer" | "leftGameRotation" | "leftRotation" | "leftOrientation" | "leftStepDetector" | "leftStepCounter" | "leftActivity" | "leftDeviceOrientation" | "leftTapDetector" | "leftPressure" | "leftButtons" | "leftTouches" | "leftLight" | "leftConnectionMessage" | "leftConnectionStatus" | "leftIsLast" | "leftPressureAutoRangeEnabled" | "leftPressureAutoRangeDisabled" | "leftPressureAutoRange" | "leftPressureMotionAutoRangeEnabled" | "leftPressureMotionAutoRangeDisabled" | "leftPressureMotionAutoRange" | "leftIsRecordingPressureCalibrationData" | "leftPressureCalibrationDataRecordStart" | "leftPressureCalibrationDataRecordStop" | "leftPressureCalibrationDataRecordingProgress" | "leftIsTrainingPressureCalibration" | "leftPressureCalibrationTrainStart" | "leftPressureCalibrationTrainEnd" | "leftPressureCalibrationTrainProgress" | "leftCalibratedPressureModel" | "leftNumberOfButtons" | "leftButton" | "leftButtonDown" | "leftButtonUp" | "leftNumberOfTouches" | "leftTouch" | "leftTouchDown" | "leftTouchUp" | "leftFileTransferProgress" | "leftFileTransferComplete" | "leftFileReceived" | "leftFileSent" | "leftGetEnableWifiConnection" | "leftCameraImageProgress" | "leftCameraImage" | "leftIsRecordingCamera" | "leftCameraRecording" | "leftAutoPicture" | "leftStartRecordingCamera" | "leftStopRecordingCamera" | "leftIsRecordingMicrophone" | "leftMicrophoneRecording" | "leftStartRecordingMicrophone" | "leftStopRecordingMicrophone" | "leftDisplayContextState" | "leftDisplayColor" | "leftDisplayColorOpacity" | "leftDisplayOpacity" | "leftDisplaySpriteSheetUploadStart" | "leftDisplaySpriteSheetUploadProgress" | "leftDisplaySpriteSheetUploadComplete" | "leftSetLed" | "leftFirmwareImages" | "leftFirmwareUploadProgress" | "leftFirmwareStatus", DevicePairEventMessages, T>) => void, options?: EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "sensorData" | "isConnected" | "deviceOrientation" | "pressure" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "*" | "rightManufacturerName" | "rightModelNumber" | "rightHardwareRevision" | "rightFirmwareRevision" | "rightSoftwareRevision" | "rightPnpId" | "rightSerialNumber" | "rightBatteryLevel" | "rightSmp" | "rightConnecting" | "rightConnected" | "rightDisconnecting" | "rightIsCharging" | "rightGetBatteryCurrent" | "rightGetMtu" | "rightGetId" | "rightGetName" | "rightGetType" | "rightGetCurrentTime" | "rightGetSensorConfiguration" | "rightSensorData" | "rightGetFileTypes" | "rightMaxFileLength" | "rightGetFileType" | "rightGetFileLength" | "rightGetFileChecksum" | "rightFileTransferStatus" | "rightGetFileBlock" | "rightFileBytesTransferred" | "rightGetTfliteName" | "rightGetTfliteTask" | "rightGetTfliteSampleRate" | "rightGetTfliteSensorTypes" | "rightTfliteIsReady" | "rightGetTfliteCaptureDelay" | "rightGetTfliteThreshold" | "rightGetTfliteInferencingEnabled" | "rightTfliteInference" | "rightIsWifiAvailable" | "rightGetWifiSSID" | "rightGetWifiPassword" | "rightIsWifiConnected" | "rightIpAddress" | "rightCameraStatus" | "rightGetCameraConfiguration" | "rightMicrophoneStatus" | "rightGetMicrophoneConfiguration" | "rightMicrophoneData" | "rightIsDisplayAvailable" | "rightDisplayStatus" | "rightDisplayInformation" | "rightGetDisplayBrightness" | "rightDisplayContextCommands" | "rightDisplayReady" | "rightGetDisplaySpriteSheetName" | "rightGetLedInformation" | "rightDeviceInformation" | "rightNotConnected" | "rightIsConnected" | "rightBarometer" | "rightAcceleration" | "rightGravity" | "rightLinearAcceleration" | "rightGyroscope" | "rightMagnetometer" | "rightGameRotation" | "rightRotation" | "rightOrientation" | "rightStepDetector" | "rightStepCounter" | "rightActivity" | "rightDeviceOrientation" | "rightTapDetector" | "rightPressure" | "rightButtons" | "rightTouches" | "rightLight" | "rightConnectionMessage" | "rightConnectionStatus" | "rightIsLast" | "rightPressureAutoRangeEnabled" | "rightPressureAutoRangeDisabled" | "rightPressureAutoRange" | "rightPressureMotionAutoRangeEnabled" | "rightPressureMotionAutoRangeDisabled" | "rightPressureMotionAutoRange" | "rightIsRecordingPressureCalibrationData" | "rightPressureCalibrationDataRecordStart" | "rightPressureCalibrationDataRecordStop" | "rightPressureCalibrationDataRecordingProgress" | "rightIsTrainingPressureCalibration" | "rightPressureCalibrationTrainStart" | "rightPressureCalibrationTrainEnd" | "rightPressureCalibrationTrainProgress" | "rightCalibratedPressureModel" | "rightNumberOfButtons" | "rightButton" | "rightButtonDown" | "rightButtonUp" | "rightNumberOfTouches" | "rightTouch" | "rightTouchDown" | "rightTouchUp" | "rightFileTransferProgress" | "rightFileTransferComplete" | "rightFileReceived" | "rightFileSent" | "rightGetEnableWifiConnection" | "rightCameraImageProgress" | "rightCameraImage" | "rightIsRecordingCamera" | "rightCameraRecording" | "rightAutoPicture" | "rightStartRecordingCamera" | "rightStopRecordingCamera" | "rightIsRecordingMicrophone" | "rightMicrophoneRecording" | "rightStartRecordingMicrophone" | "rightStopRecordingMicrophone" | "rightDisplayContextState" | "rightDisplayColor" | "rightDisplayColorOpacity" | "rightDisplayOpacity" | "rightDisplaySpriteSheetUploadStart" | "rightDisplaySpriteSheetUploadProgress" | "rightDisplaySpriteSheetUploadComplete" | "rightSetLed" | "rightFirmwareImages" | "rightFirmwareUploadProgress" | "rightFirmwareStatus" | "leftManufacturerName" | "leftModelNumber" | "leftHardwareRevision" | "leftFirmwareRevision" | "leftSoftwareRevision" | "leftPnpId" | "leftSerialNumber" | "leftBatteryLevel" | "leftSmp" | "leftConnecting" | "leftConnected" | "leftDisconnecting" | "leftIsCharging" | "leftGetBatteryCurrent" | "leftGetMtu" | "leftGetId" | "leftGetName" | "leftGetType" | "leftGetCurrentTime" | "leftGetSensorConfiguration" | "leftSensorData" | "leftGetFileTypes" | "leftMaxFileLength" | "leftGetFileType" | "leftGetFileLength" | "leftGetFileChecksum" | "leftFileTransferStatus" | "leftGetFileBlock" | "leftFileBytesTransferred" | "leftGetTfliteName" | "leftGetTfliteTask" | "leftGetTfliteSampleRate" | "leftGetTfliteSensorTypes" | "leftTfliteIsReady" | "leftGetTfliteCaptureDelay" | "leftGetTfliteThreshold" | "leftGetTfliteInferencingEnabled" | "leftTfliteInference" | "leftIsWifiAvailable" | "leftGetWifiSSID" | "leftGetWifiPassword" | "leftIsWifiConnected" | "leftIpAddress" | "leftCameraStatus" | "leftGetCameraConfiguration" | "leftMicrophoneStatus" | "leftGetMicrophoneConfiguration" | "leftMicrophoneData" | "leftIsDisplayAvailable" | "leftDisplayStatus" | "leftDisplayInformation" | "leftGetDisplayBrightness" | "leftDisplayContextCommands" | "leftDisplayReady" | "leftGetDisplaySpriteSheetName" | "leftGetLedInformation" | "leftDeviceInformation" | "leftNotConnected" | "leftIsConnected" | "leftBarometer" | "leftAcceleration" | "leftGravity" | "leftLinearAcceleration" | "leftGyroscope" | "leftMagnetometer" | "leftGameRotation" | "leftRotation" | "leftOrientation" | "leftStepDetector" | "leftStepCounter" | "leftActivity" | "leftDeviceOrientation" | "leftTapDetector" | "leftPressure" | "leftButtons" | "leftTouches" | "leftLight" | "leftConnectionMessage" | "leftConnectionStatus" | "leftIsLast" | "leftPressureAutoRangeEnabled" | "leftPressureAutoRangeDisabled" | "leftPressureAutoRange" | "leftPressureMotionAutoRangeEnabled" | "leftPressureMotionAutoRangeDisabled" | "leftPressureMotionAutoRange" | "leftIsRecordingPressureCalibrationData" | "leftPressureCalibrationDataRecordStart" | "leftPressureCalibrationDataRecordStop" | "leftPressureCalibrationDataRecordingProgress" | "leftIsTrainingPressureCalibration" | "leftPressureCalibrationTrainStart" | "leftPressureCalibrationTrainEnd" | "leftPressureCalibrationTrainProgress" | "leftCalibratedPressureModel" | "leftNumberOfButtons" | "leftButton" | "leftButtonDown" | "leftButtonUp" | "leftNumberOfTouches" | "leftTouch" | "leftTouchDown" | "leftTouchUp" | "leftFileTransferProgress" | "leftFileTransferComplete" | "leftFileReceived" | "leftFileSent" | "leftGetEnableWifiConnection" | "leftCameraImageProgress" | "leftCameraImage" | "leftIsRecordingCamera" | "leftCameraRecording" | "leftAutoPicture" | "leftStartRecordingCamera" | "leftStopRecordingCamera" | "leftIsRecordingMicrophone" | "leftMicrophoneRecording" | "leftStartRecordingMicrophone" | "leftStopRecordingMicrophone" | "leftDisplayContextState" | "leftDisplayColor" | "leftDisplayColorOpacity" | "leftDisplayOpacity" | "leftDisplaySpriteSheetUploadStart" | "leftDisplaySpriteSheetUploadProgress" | "leftDisplaySpriteSheetUploadComplete" | "leftSetLed" | "leftFirmwareImages" | "leftFirmwareUploadProgress" | "leftFirmwareStatus">(type: T, listener: (event: ListenerEvent<DevicePair, "sensorData" | "isConnected" | "deviceOrientation" | "pressure" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "rightManufacturerName" | "rightModelNumber" | "rightHardwareRevision" | "rightFirmwareRevision" | "rightSoftwareRevision" | "rightPnpId" | "rightSerialNumber" | "rightBatteryLevel" | "rightSmp" | "rightConnecting" | "rightConnected" | "rightDisconnecting" | "rightIsCharging" | "rightGetBatteryCurrent" | "rightGetMtu" | "rightGetId" | "rightGetName" | "rightGetType" | "rightGetCurrentTime" | "rightGetSensorConfiguration" | "rightSensorData" | "rightGetFileTypes" | "rightMaxFileLength" | "rightGetFileType" | "rightGetFileLength" | "rightGetFileChecksum" | "rightFileTransferStatus" | "rightGetFileBlock" | "rightFileBytesTransferred" | "rightGetTfliteName" | "rightGetTfliteTask" | "rightGetTfliteSampleRate" | "rightGetTfliteSensorTypes" | "rightTfliteIsReady" | "rightGetTfliteCaptureDelay" | "rightGetTfliteThreshold" | "rightGetTfliteInferencingEnabled" | "rightTfliteInference" | "rightIsWifiAvailable" | "rightGetWifiSSID" | "rightGetWifiPassword" | "rightIsWifiConnected" | "rightIpAddress" | "rightCameraStatus" | "rightGetCameraConfiguration" | "rightMicrophoneStatus" | "rightGetMicrophoneConfiguration" | "rightMicrophoneData" | "rightIsDisplayAvailable" | "rightDisplayStatus" | "rightDisplayInformation" | "rightGetDisplayBrightness" | "rightDisplayContextCommands" | "rightDisplayReady" | "rightGetDisplaySpriteSheetName" | "rightGetLedInformation" | "rightDeviceInformation" | "rightNotConnected" | "rightIsConnected" | "rightBarometer" | "rightAcceleration" | "rightGravity" | "rightLinearAcceleration" | "rightGyroscope" | "rightMagnetometer" | "rightGameRotation" | "rightRotation" | "rightOrientation" | "rightStepDetector" | "rightStepCounter" | "rightActivity" | "rightDeviceOrientation" | "rightTapDetector" | "rightPressure" | "rightButtons" | "rightTouches" | "rightLight" | "rightConnectionMessage" | "rightConnectionStatus" | "rightIsLast" | "rightPressureAutoRangeEnabled" | "rightPressureAutoRangeDisabled" | "rightPressureAutoRange" | "rightPressureMotionAutoRangeEnabled" | "rightPressureMotionAutoRangeDisabled" | "rightPressureMotionAutoRange" | "rightIsRecordingPressureCalibrationData" | "rightPressureCalibrationDataRecordStart" | "rightPressureCalibrationDataRecordStop" | "rightPressureCalibrationDataRecordingProgress" | "rightIsTrainingPressureCalibration" | "rightPressureCalibrationTrainStart" | "rightPressureCalibrationTrainEnd" | "rightPressureCalibrationTrainProgress" | "rightCalibratedPressureModel" | "rightNumberOfButtons" | "rightButton" | "rightButtonDown" | "rightButtonUp" | "rightNumberOfTouches" | "rightTouch" | "rightTouchDown" | "rightTouchUp" | "rightFileTransferProgress" | "rightFileTransferComplete" | "rightFileReceived" | "rightFileSent" | "rightGetEnableWifiConnection" | "rightCameraImageProgress" | "rightCameraImage" | "rightIsRecordingCamera" | "rightCameraRecording" | "rightAutoPicture" | "rightStartRecordingCamera" | "rightStopRecordingCamera" | "rightIsRecordingMicrophone" | "rightMicrophoneRecording" | "rightStartRecordingMicrophone" | "rightStopRecordingMicrophone" | "rightDisplayContextState" | "rightDisplayColor" | "rightDisplayColorOpacity" | "rightDisplayOpacity" | "rightDisplaySpriteSheetUploadStart" | "rightDisplaySpriteSheetUploadProgress" | "rightDisplaySpriteSheetUploadComplete" | "rightSetLed" | "rightFirmwareImages" | "rightFirmwareUploadProgress" | "rightFirmwareStatus" | "leftManufacturerName" | "leftModelNumber" | "leftHardwareRevision" | "leftFirmwareRevision" | "leftSoftwareRevision" | "leftPnpId" | "leftSerialNumber" | "leftBatteryLevel" | "leftSmp" | "leftConnecting" | "leftConnected" | "leftDisconnecting" | "leftIsCharging" | "leftGetBatteryCurrent" | "leftGetMtu" | "leftGetId" | "leftGetName" | "leftGetType" | "leftGetCurrentTime" | "leftGetSensorConfiguration" | "leftSensorData" | "leftGetFileTypes" | "leftMaxFileLength" | "leftGetFileType" | "leftGetFileLength" | "leftGetFileChecksum" | "leftFileTransferStatus" | "leftGetFileBlock" | "leftFileBytesTransferred" | "leftGetTfliteName" | "leftGetTfliteTask" | "leftGetTfliteSampleRate" | "leftGetTfliteSensorTypes" | "leftTfliteIsReady" | "leftGetTfliteCaptureDelay" | "leftGetTfliteThreshold" | "leftGetTfliteInferencingEnabled" | "leftTfliteInference" | "leftIsWifiAvailable" | "leftGetWifiSSID" | "leftGetWifiPassword" | "leftIsWifiConnected" | "leftIpAddress" | "leftCameraStatus" | "leftGetCameraConfiguration" | "leftMicrophoneStatus" | "leftGetMicrophoneConfiguration" | "leftMicrophoneData" | "leftIsDisplayAvailable" | "leftDisplayStatus" | "leftDisplayInformation" | "leftGetDisplayBrightness" | "leftDisplayContextCommands" | "leftDisplayReady" | "leftGetDisplaySpriteSheetName" | "leftGetLedInformation" | "leftDeviceInformation" | "leftNotConnected" | "leftIsConnected" | "leftBarometer" | "leftAcceleration" | "leftGravity" | "leftLinearAcceleration" | "leftGyroscope" | "leftMagnetometer" | "leftGameRotation" | "leftRotation" | "leftOrientation" | "leftStepDetector" | "leftStepCounter" | "leftActivity" | "leftDeviceOrientation" | "leftTapDetector" | "leftPressure" | "leftButtons" | "leftTouches" | "leftLight" | "leftConnectionMessage" | "leftConnectionStatus" | "leftIsLast" | "leftPressureAutoRangeEnabled" | "leftPressureAutoRangeDisabled" | "leftPressureAutoRange" | "leftPressureMotionAutoRangeEnabled" | "leftPressureMotionAutoRangeDisabled" | "leftPressureMotionAutoRange" | "leftIsRecordingPressureCalibrationData" | "leftPressureCalibrationDataRecordStart" | "leftPressureCalibrationDataRecordStop" | "leftPressureCalibrationDataRecordingProgress" | "leftIsTrainingPressureCalibration" | "leftPressureCalibrationTrainStart" | "leftPressureCalibrationTrainEnd" | "leftPressureCalibrationTrainProgress" | "leftCalibratedPressureModel" | "leftNumberOfButtons" | "leftButton" | "leftButtonDown" | "leftButtonUp" | "leftNumberOfTouches" | "leftTouch" | "leftTouchDown" | "leftTouchUp" | "leftFileTransferProgress" | "leftFileTransferComplete" | "leftFileReceived" | "leftFileSent" | "leftGetEnableWifiConnection" | "leftCameraImageProgress" | "leftCameraImage" | "leftIsRecordingCamera" | "leftCameraRecording" | "leftAutoPicture" | "leftStartRecordingCamera" | "leftStopRecordingCamera" | "leftIsRecordingMicrophone" | "leftMicrophoneRecording" | "leftStartRecordingMicrophone" | "leftStopRecordingMicrophone" | "leftDisplayContextState" | "leftDisplayColor" | "leftDisplayColorOpacity" | "leftDisplayOpacity" | "leftDisplaySpriteSheetUploadStart" | "leftDisplaySpriteSheetUploadProgress" | "leftDisplaySpriteSheetUploadComplete" | "leftSetLed" | "leftFirmwareImages" | "leftFirmwareUploadProgress" | "leftFirmwareStatus", DevicePairEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "sensorData" | "isConnected" | "deviceOrientation" | "pressure" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "rightManufacturerName" | "rightModelNumber" | "rightHardwareRevision" | "rightFirmwareRevision" | "rightSoftwareRevision" | "rightPnpId" | "rightSerialNumber" | "rightBatteryLevel" | "rightSmp" | "rightConnecting" | "rightConnected" | "rightDisconnecting" | "rightIsCharging" | "rightGetBatteryCurrent" | "rightGetMtu" | "rightGetId" | "rightGetName" | "rightGetType" | "rightGetCurrentTime" | "rightGetSensorConfiguration" | "rightSensorData" | "rightGetFileTypes" | "rightMaxFileLength" | "rightGetFileType" | "rightGetFileLength" | "rightGetFileChecksum" | "rightFileTransferStatus" | "rightGetFileBlock" | "rightFileBytesTransferred" | "rightGetTfliteName" | "rightGetTfliteTask" | "rightGetTfliteSampleRate" | "rightGetTfliteSensorTypes" | "rightTfliteIsReady" | "rightGetTfliteCaptureDelay" | "rightGetTfliteThreshold" | "rightGetTfliteInferencingEnabled" | "rightTfliteInference" | "rightIsWifiAvailable" | "rightGetWifiSSID" | "rightGetWifiPassword" | "rightIsWifiConnected" | "rightIpAddress" | "rightCameraStatus" | "rightGetCameraConfiguration" | "rightMicrophoneStatus" | "rightGetMicrophoneConfiguration" | "rightMicrophoneData" | "rightIsDisplayAvailable" | "rightDisplayStatus" | "rightDisplayInformation" | "rightGetDisplayBrightness" | "rightDisplayContextCommands" | "rightDisplayReady" | "rightGetDisplaySpriteSheetName" | "rightGetLedInformation" | "rightDeviceInformation" | "rightNotConnected" | "rightIsConnected" | "rightBarometer" | "rightAcceleration" | "rightGravity" | "rightLinearAcceleration" | "rightGyroscope" | "rightMagnetometer" | "rightGameRotation" | "rightRotation" | "rightOrientation" | "rightStepDetector" | "rightStepCounter" | "rightActivity" | "rightDeviceOrientation" | "rightTapDetector" | "rightPressure" | "rightButtons" | "rightTouches" | "rightLight" | "rightConnectionMessage" | "rightConnectionStatus" | "rightIsLast" | "rightPressureAutoRangeEnabled" | "rightPressureAutoRangeDisabled" | "rightPressureAutoRange" | "rightPressureMotionAutoRangeEnabled" | "rightPressureMotionAutoRangeDisabled" | "rightPressureMotionAutoRange" | "rightIsRecordingPressureCalibrationData" | "rightPressureCalibrationDataRecordStart" | "rightPressureCalibrationDataRecordStop" | "rightPressureCalibrationDataRecordingProgress" | "rightIsTrainingPressureCalibration" | "rightPressureCalibrationTrainStart" | "rightPressureCalibrationTrainEnd" | "rightPressureCalibrationTrainProgress" | "rightCalibratedPressureModel" | "rightNumberOfButtons" | "rightButton" | "rightButtonDown" | "rightButtonUp" | "rightNumberOfTouches" | "rightTouch" | "rightTouchDown" | "rightTouchUp" | "rightFileTransferProgress" | "rightFileTransferComplete" | "rightFileReceived" | "rightFileSent" | "rightGetEnableWifiConnection" | "rightCameraImageProgress" | "rightCameraImage" | "rightIsRecordingCamera" | "rightCameraRecording" | "rightAutoPicture" | "rightStartRecordingCamera" | "rightStopRecordingCamera" | "rightIsRecordingMicrophone" | "rightMicrophoneRecording" | "rightStartRecordingMicrophone" | "rightStopRecordingMicrophone" | "rightDisplayContextState" | "rightDisplayColor" | "rightDisplayColorOpacity" | "rightDisplayOpacity" | "rightDisplaySpriteSheetUploadStart" | "rightDisplaySpriteSheetUploadProgress" | "rightDisplaySpriteSheetUploadComplete" | "rightSetLed" | "rightFirmwareImages" | "rightFirmwareUploadProgress" | "rightFirmwareStatus" | "leftManufacturerName" | "leftModelNumber" | "leftHardwareRevision" | "leftFirmwareRevision" | "leftSoftwareRevision" | "leftPnpId" | "leftSerialNumber" | "leftBatteryLevel" | "leftSmp" | "leftConnecting" | "leftConnected" | "leftDisconnecting" | "leftIsCharging" | "leftGetBatteryCurrent" | "leftGetMtu" | "leftGetId" | "leftGetName" | "leftGetType" | "leftGetCurrentTime" | "leftGetSensorConfiguration" | "leftSensorData" | "leftGetFileTypes" | "leftMaxFileLength" | "leftGetFileType" | "leftGetFileLength" | "leftGetFileChecksum" | "leftFileTransferStatus" | "leftGetFileBlock" | "leftFileBytesTransferred" | "leftGetTfliteName" | "leftGetTfliteTask" | "leftGetTfliteSampleRate" | "leftGetTfliteSensorTypes" | "leftTfliteIsReady" | "leftGetTfliteCaptureDelay" | "leftGetTfliteThreshold" | "leftGetTfliteInferencingEnabled" | "leftTfliteInference" | "leftIsWifiAvailable" | "leftGetWifiSSID" | "leftGetWifiPassword" | "leftIsWifiConnected" | "leftIpAddress" | "leftCameraStatus" | "leftGetCameraConfiguration" | "leftMicrophoneStatus" | "leftGetMicrophoneConfiguration" | "leftMicrophoneData" | "leftIsDisplayAvailable" | "leftDisplayStatus" | "leftDisplayInformation" | "leftGetDisplayBrightness" | "leftDisplayContextCommands" | "leftDisplayReady" | "leftGetDisplaySpriteSheetName" | "leftGetLedInformation" | "leftDeviceInformation" | "leftNotConnected" | "leftIsConnected" | "leftBarometer" | "leftAcceleration" | "leftGravity" | "leftLinearAcceleration" | "leftGyroscope" | "leftMagnetometer" | "leftGameRotation" | "leftRotation" | "leftOrientation" | "leftStepDetector" | "leftStepCounter" | "leftActivity" | "leftDeviceOrientation" | "leftTapDetector" | "leftPressure" | "leftButtons" | "leftTouches" | "leftLight" | "leftConnectionMessage" | "leftConnectionStatus" | "leftIsLast" | "leftPressureAutoRangeEnabled" | "leftPressureAutoRangeDisabled" | "leftPressureAutoRange" | "leftPressureMotionAutoRangeEnabled" | "leftPressureMotionAutoRangeDisabled" | "leftPressureMotionAutoRange" | "leftIsRecordingPressureCalibrationData" | "leftPressureCalibrationDataRecordStart" | "leftPressureCalibrationDataRecordStop" | "leftPressureCalibrationDataRecordingProgress" | "leftIsTrainingPressureCalibration" | "leftPressureCalibrationTrainStart" | "leftPressureCalibrationTrainEnd" | "leftPressureCalibrationTrainProgress" | "leftCalibratedPressureModel" | "leftNumberOfButtons" | "leftButton" | "leftButtonDown" | "leftButtonUp" | "leftNumberOfTouches" | "leftTouch" | "leftTouchDown" | "leftTouchUp" | "leftFileTransferProgress" | "leftFileTransferComplete" | "leftFileReceived" | "leftFileSent" | "leftGetEnableWifiConnection" | "leftCameraImageProgress" | "leftCameraImage" | "leftIsRecordingCamera" | "leftCameraRecording" | "leftAutoPicture" | "leftStartRecordingCamera" | "leftStopRecordingCamera" | "leftIsRecordingMicrophone" | "leftMicrophoneRecording" | "leftStartRecordingMicrophone" | "leftStopRecordingMicrophone" | "leftDisplayContextState" | "leftDisplayColor" | "leftDisplayColorOpacity" | "leftDisplayOpacity" | "leftDisplaySpriteSheetUploadStart" | "leftDisplaySpriteSheetUploadProgress" | "leftDisplaySpriteSheetUploadComplete" | "leftSetLed" | "leftFirmwareImages" | "leftFirmwareUploadProgress" | "leftFirmwareStatus">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<ListenerEvent<DevicePair, "sensorData" | "isConnected" | "deviceOrientation" | "pressure" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "rightManufacturerName" | "rightModelNumber" | "rightHardwareRevision" | "rightFirmwareRevision" | "rightSoftwareRevision" | "rightPnpId" | "rightSerialNumber" | "rightBatteryLevel" | "rightSmp" | "rightConnecting" | "rightConnected" | "rightDisconnecting" | "rightIsCharging" | "rightGetBatteryCurrent" | "rightGetMtu" | "rightGetId" | "rightGetName" | "rightGetType" | "rightGetCurrentTime" | "rightGetSensorConfiguration" | "rightSensorData" | "rightGetFileTypes" | "rightMaxFileLength" | "rightGetFileType" | "rightGetFileLength" | "rightGetFileChecksum" | "rightFileTransferStatus" | "rightGetFileBlock" | "rightFileBytesTransferred" | "rightGetTfliteName" | "rightGetTfliteTask" | "rightGetTfliteSampleRate" | "rightGetTfliteSensorTypes" | "rightTfliteIsReady" | "rightGetTfliteCaptureDelay" | "rightGetTfliteThreshold" | "rightGetTfliteInferencingEnabled" | "rightTfliteInference" | "rightIsWifiAvailable" | "rightGetWifiSSID" | "rightGetWifiPassword" | "rightIsWifiConnected" | "rightIpAddress" | "rightCameraStatus" | "rightGetCameraConfiguration" | "rightMicrophoneStatus" | "rightGetMicrophoneConfiguration" | "rightMicrophoneData" | "rightIsDisplayAvailable" | "rightDisplayStatus" | "rightDisplayInformation" | "rightGetDisplayBrightness" | "rightDisplayContextCommands" | "rightDisplayReady" | "rightGetDisplaySpriteSheetName" | "rightGetLedInformation" | "rightDeviceInformation" | "rightNotConnected" | "rightIsConnected" | "rightBarometer" | "rightAcceleration" | "rightGravity" | "rightLinearAcceleration" | "rightGyroscope" | "rightMagnetometer" | "rightGameRotation" | "rightRotation" | "rightOrientation" | "rightStepDetector" | "rightStepCounter" | "rightActivity" | "rightDeviceOrientation" | "rightTapDetector" | "rightPressure" | "rightButtons" | "rightTouches" | "rightLight" | "rightConnectionMessage" | "rightConnectionStatus" | "rightIsLast" | "rightPressureAutoRangeEnabled" | "rightPressureAutoRangeDisabled" | "rightPressureAutoRange" | "rightPressureMotionAutoRangeEnabled" | "rightPressureMotionAutoRangeDisabled" | "rightPressureMotionAutoRange" | "rightIsRecordingPressureCalibrationData" | "rightPressureCalibrationDataRecordStart" | "rightPressureCalibrationDataRecordStop" | "rightPressureCalibrationDataRecordingProgress" | "rightIsTrainingPressureCalibration" | "rightPressureCalibrationTrainStart" | "rightPressureCalibrationTrainEnd" | "rightPressureCalibrationTrainProgress" | "rightCalibratedPressureModel" | "rightNumberOfButtons" | "rightButton" | "rightButtonDown" | "rightButtonUp" | "rightNumberOfTouches" | "rightTouch" | "rightTouchDown" | "rightTouchUp" | "rightFileTransferProgress" | "rightFileTransferComplete" | "rightFileReceived" | "rightFileSent" | "rightGetEnableWifiConnection" | "rightCameraImageProgress" | "rightCameraImage" | "rightIsRecordingCamera" | "rightCameraRecording" | "rightAutoPicture" | "rightStartRecordingCamera" | "rightStopRecordingCamera" | "rightIsRecordingMicrophone" | "rightMicrophoneRecording" | "rightStartRecordingMicrophone" | "rightStopRecordingMicrophone" | "rightDisplayContextState" | "rightDisplayColor" | "rightDisplayColorOpacity" | "rightDisplayOpacity" | "rightDisplaySpriteSheetUploadStart" | "rightDisplaySpriteSheetUploadProgress" | "rightDisplaySpriteSheetUploadComplete" | "rightSetLed" | "rightFirmwareImages" | "rightFirmwareUploadProgress" | "rightFirmwareStatus" | "leftManufacturerName" | "leftModelNumber" | "leftHardwareRevision" | "leftFirmwareRevision" | "leftSoftwareRevision" | "leftPnpId" | "leftSerialNumber" | "leftBatteryLevel" | "leftSmp" | "leftConnecting" | "leftConnected" | "leftDisconnecting" | "leftIsCharging" | "leftGetBatteryCurrent" | "leftGetMtu" | "leftGetId" | "leftGetName" | "leftGetType" | "leftGetCurrentTime" | "leftGetSensorConfiguration" | "leftSensorData" | "leftGetFileTypes" | "leftMaxFileLength" | "leftGetFileType" | "leftGetFileLength" | "leftGetFileChecksum" | "leftFileTransferStatus" | "leftGetFileBlock" | "leftFileBytesTransferred" | "leftGetTfliteName" | "leftGetTfliteTask" | "leftGetTfliteSampleRate" | "leftGetTfliteSensorTypes" | "leftTfliteIsReady" | "leftGetTfliteCaptureDelay" | "leftGetTfliteThreshold" | "leftGetTfliteInferencingEnabled" | "leftTfliteInference" | "leftIsWifiAvailable" | "leftGetWifiSSID" | "leftGetWifiPassword" | "leftIsWifiConnected" | "leftIpAddress" | "leftCameraStatus" | "leftGetCameraConfiguration" | "leftMicrophoneStatus" | "leftGetMicrophoneConfiguration" | "leftMicrophoneData" | "leftIsDisplayAvailable" | "leftDisplayStatus" | "leftDisplayInformation" | "leftGetDisplayBrightness" | "leftDisplayContextCommands" | "leftDisplayReady" | "leftGetDisplaySpriteSheetName" | "leftGetLedInformation" | "leftDeviceInformation" | "leftNotConnected" | "leftIsConnected" | "leftBarometer" | "leftAcceleration" | "leftGravity" | "leftLinearAcceleration" | "leftGyroscope" | "leftMagnetometer" | "leftGameRotation" | "leftRotation" | "leftOrientation" | "leftStepDetector" | "leftStepCounter" | "leftActivity" | "leftDeviceOrientation" | "leftTapDetector" | "leftPressure" | "leftButtons" | "leftTouches" | "leftLight" | "leftConnectionMessage" | "leftConnectionStatus" | "leftIsLast" | "leftPressureAutoRangeEnabled" | "leftPressureAutoRangeDisabled" | "leftPressureAutoRange" | "leftPressureMotionAutoRangeEnabled" | "leftPressureMotionAutoRangeDisabled" | "leftPressureMotionAutoRange" | "leftIsRecordingPressureCalibrationData" | "leftPressureCalibrationDataRecordStart" | "leftPressureCalibrationDataRecordStop" | "leftPressureCalibrationDataRecordingProgress" | "leftIsTrainingPressureCalibration" | "leftPressureCalibrationTrainStart" | "leftPressureCalibrationTrainEnd" | "leftPressureCalibrationTrainProgress" | "leftCalibratedPressureModel" | "leftNumberOfButtons" | "leftButton" | "leftButtonDown" | "leftButtonUp" | "leftNumberOfTouches" | "leftTouch" | "leftTouchDown" | "leftTouchUp" | "leftFileTransferProgress" | "leftFileTransferComplete" | "leftFileReceived" | "leftFileSent" | "leftGetEnableWifiConnection" | "leftCameraImageProgress" | "leftCameraImage" | "leftIsRecordingCamera" | "leftCameraRecording" | "leftAutoPicture" | "leftStartRecordingCamera" | "leftStopRecordingCamera" | "leftIsRecordingMicrophone" | "leftMicrophoneRecording" | "leftStartRecordingMicrophone" | "leftStopRecordingMicrophone" | "leftDisplayContextState" | "leftDisplayColor" | "leftDisplayColorOpacity" | "leftDisplayOpacity" | "leftDisplaySpriteSheetUploadStart" | "leftDisplaySpriteSheetUploadProgress" | "leftDisplaySpriteSheetUploadComplete" | "leftSetLed" | "leftFirmwareImages" | "leftFirmwareUploadProgress" | "leftFirmwareStatus", DevicePairEventMessages, T>>;
    get removeEventListeners(): <T extends "sensorData" | "isConnected" | "deviceOrientation" | "pressure" | "deviceManufacturerName" | "deviceModelNumber" | "deviceHardwareRevision" | "deviceFirmwareRevision" | "deviceSoftwareRevision" | "devicePnpId" | "deviceSerialNumber" | "deviceBatteryLevel" | "deviceSmp" | "deviceConnecting" | "deviceConnected" | "deviceDisconnecting" | "deviceIsCharging" | "deviceGetBatteryCurrent" | "deviceGetMtu" | "deviceGetId" | "deviceGetName" | "deviceGetType" | "deviceGetCurrentTime" | "deviceGetSensorConfiguration" | "deviceSensorData" | "deviceGetFileTypes" | "deviceMaxFileLength" | "deviceGetFileType" | "deviceGetFileLength" | "deviceGetFileChecksum" | "deviceFileTransferStatus" | "deviceGetFileBlock" | "deviceFileBytesTransferred" | "deviceGetTfliteName" | "deviceGetTfliteTask" | "deviceGetTfliteSampleRate" | "deviceGetTfliteSensorTypes" | "deviceTfliteIsReady" | "deviceGetTfliteCaptureDelay" | "deviceGetTfliteThreshold" | "deviceGetTfliteInferencingEnabled" | "deviceTfliteInference" | "deviceIsWifiAvailable" | "deviceGetWifiSSID" | "deviceGetWifiPassword" | "deviceIsWifiConnected" | "deviceIpAddress" | "deviceCameraStatus" | "deviceGetCameraConfiguration" | "deviceMicrophoneStatus" | "deviceGetMicrophoneConfiguration" | "deviceMicrophoneData" | "deviceIsDisplayAvailable" | "deviceDisplayStatus" | "deviceDisplayInformation" | "deviceGetDisplayBrightness" | "deviceDisplayContextCommands" | "deviceDisplayReady" | "deviceGetDisplaySpriteSheetName" | "deviceGetLedInformation" | "deviceDeviceInformation" | "deviceNotConnected" | "deviceIsConnected" | "deviceBarometer" | "deviceAcceleration" | "deviceGravity" | "deviceLinearAcceleration" | "deviceGyroscope" | "deviceMagnetometer" | "deviceGameRotation" | "deviceRotation" | "deviceStepDetector" | "deviceStepCounter" | "deviceActivity" | "deviceDeviceOrientation" | "deviceTapDetector" | "devicePressure" | "deviceButtons" | "deviceTouches" | "deviceLight" | "deviceConnectionMessage" | "deviceConnectionStatus" | "deviceIsLast" | "devicePressureAutoRangeEnabled" | "devicePressureAutoRangeDisabled" | "devicePressureAutoRange" | "devicePressureMotionAutoRangeEnabled" | "devicePressureMotionAutoRangeDisabled" | "devicePressureMotionAutoRange" | "deviceIsRecordingPressureCalibrationData" | "devicePressureCalibrationDataRecordStart" | "devicePressureCalibrationDataRecordStop" | "devicePressureCalibrationDataRecordingProgress" | "deviceIsTrainingPressureCalibration" | "devicePressureCalibrationTrainStart" | "devicePressureCalibrationTrainEnd" | "devicePressureCalibrationTrainProgress" | "deviceCalibratedPressureModel" | "deviceNumberOfButtons" | "deviceButton" | "deviceButtonDown" | "deviceButtonUp" | "deviceNumberOfTouches" | "deviceTouch" | "deviceTouchDown" | "deviceTouchUp" | "deviceFileTransferProgress" | "deviceFileTransferComplete" | "deviceFileReceived" | "deviceFileSent" | "deviceGetEnableWifiConnection" | "deviceCameraImageProgress" | "deviceCameraImage" | "deviceIsRecordingCamera" | "deviceCameraRecording" | "deviceAutoPicture" | "deviceStartRecordingCamera" | "deviceStopRecordingCamera" | "deviceIsRecordingMicrophone" | "deviceMicrophoneRecording" | "deviceStartRecordingMicrophone" | "deviceStopRecordingMicrophone" | "deviceDisplayContextState" | "deviceDisplayColor" | "deviceDisplayColorOpacity" | "deviceDisplayOpacity" | "deviceDisplaySpriteSheetUploadStart" | "deviceDisplaySpriteSheetUploadProgress" | "deviceDisplaySpriteSheetUploadComplete" | "deviceSetLed" | "deviceFirmwareImages" | "deviceFirmwareUploadProgress" | "deviceFirmwareStatus" | "device*" | "*" | "rightManufacturerName" | "rightModelNumber" | "rightHardwareRevision" | "rightFirmwareRevision" | "rightSoftwareRevision" | "rightPnpId" | "rightSerialNumber" | "rightBatteryLevel" | "rightSmp" | "rightConnecting" | "rightConnected" | "rightDisconnecting" | "rightIsCharging" | "rightGetBatteryCurrent" | "rightGetMtu" | "rightGetId" | "rightGetName" | "rightGetType" | "rightGetCurrentTime" | "rightGetSensorConfiguration" | "rightSensorData" | "rightGetFileTypes" | "rightMaxFileLength" | "rightGetFileType" | "rightGetFileLength" | "rightGetFileChecksum" | "rightFileTransferStatus" | "rightGetFileBlock" | "rightFileBytesTransferred" | "rightGetTfliteName" | "rightGetTfliteTask" | "rightGetTfliteSampleRate" | "rightGetTfliteSensorTypes" | "rightTfliteIsReady" | "rightGetTfliteCaptureDelay" | "rightGetTfliteThreshold" | "rightGetTfliteInferencingEnabled" | "rightTfliteInference" | "rightIsWifiAvailable" | "rightGetWifiSSID" | "rightGetWifiPassword" | "rightIsWifiConnected" | "rightIpAddress" | "rightCameraStatus" | "rightGetCameraConfiguration" | "rightMicrophoneStatus" | "rightGetMicrophoneConfiguration" | "rightMicrophoneData" | "rightIsDisplayAvailable" | "rightDisplayStatus" | "rightDisplayInformation" | "rightGetDisplayBrightness" | "rightDisplayContextCommands" | "rightDisplayReady" | "rightGetDisplaySpriteSheetName" | "rightGetLedInformation" | "rightDeviceInformation" | "rightNotConnected" | "rightIsConnected" | "rightBarometer" | "rightAcceleration" | "rightGravity" | "rightLinearAcceleration" | "rightGyroscope" | "rightMagnetometer" | "rightGameRotation" | "rightRotation" | "rightOrientation" | "rightStepDetector" | "rightStepCounter" | "rightActivity" | "rightDeviceOrientation" | "rightTapDetector" | "rightPressure" | "rightButtons" | "rightTouches" | "rightLight" | "rightConnectionMessage" | "rightConnectionStatus" | "rightIsLast" | "rightPressureAutoRangeEnabled" | "rightPressureAutoRangeDisabled" | "rightPressureAutoRange" | "rightPressureMotionAutoRangeEnabled" | "rightPressureMotionAutoRangeDisabled" | "rightPressureMotionAutoRange" | "rightIsRecordingPressureCalibrationData" | "rightPressureCalibrationDataRecordStart" | "rightPressureCalibrationDataRecordStop" | "rightPressureCalibrationDataRecordingProgress" | "rightIsTrainingPressureCalibration" | "rightPressureCalibrationTrainStart" | "rightPressureCalibrationTrainEnd" | "rightPressureCalibrationTrainProgress" | "rightCalibratedPressureModel" | "rightNumberOfButtons" | "rightButton" | "rightButtonDown" | "rightButtonUp" | "rightNumberOfTouches" | "rightTouch" | "rightTouchDown" | "rightTouchUp" | "rightFileTransferProgress" | "rightFileTransferComplete" | "rightFileReceived" | "rightFileSent" | "rightGetEnableWifiConnection" | "rightCameraImageProgress" | "rightCameraImage" | "rightIsRecordingCamera" | "rightCameraRecording" | "rightAutoPicture" | "rightStartRecordingCamera" | "rightStopRecordingCamera" | "rightIsRecordingMicrophone" | "rightMicrophoneRecording" | "rightStartRecordingMicrophone" | "rightStopRecordingMicrophone" | "rightDisplayContextState" | "rightDisplayColor" | "rightDisplayColorOpacity" | "rightDisplayOpacity" | "rightDisplaySpriteSheetUploadStart" | "rightDisplaySpriteSheetUploadProgress" | "rightDisplaySpriteSheetUploadComplete" | "rightSetLed" | "rightFirmwareImages" | "rightFirmwareUploadProgress" | "rightFirmwareStatus" | "leftManufacturerName" | "leftModelNumber" | "leftHardwareRevision" | "leftFirmwareRevision" | "leftSoftwareRevision" | "leftPnpId" | "leftSerialNumber" | "leftBatteryLevel" | "leftSmp" | "leftConnecting" | "leftConnected" | "leftDisconnecting" | "leftIsCharging" | "leftGetBatteryCurrent" | "leftGetMtu" | "leftGetId" | "leftGetName" | "leftGetType" | "leftGetCurrentTime" | "leftGetSensorConfiguration" | "leftSensorData" | "leftGetFileTypes" | "leftMaxFileLength" | "leftGetFileType" | "leftGetFileLength" | "leftGetFileChecksum" | "leftFileTransferStatus" | "leftGetFileBlock" | "leftFileBytesTransferred" | "leftGetTfliteName" | "leftGetTfliteTask" | "leftGetTfliteSampleRate" | "leftGetTfliteSensorTypes" | "leftTfliteIsReady" | "leftGetTfliteCaptureDelay" | "leftGetTfliteThreshold" | "leftGetTfliteInferencingEnabled" | "leftTfliteInference" | "leftIsWifiAvailable" | "leftGetWifiSSID" | "leftGetWifiPassword" | "leftIsWifiConnected" | "leftIpAddress" | "leftCameraStatus" | "leftGetCameraConfiguration" | "leftMicrophoneStatus" | "leftGetMicrophoneConfiguration" | "leftMicrophoneData" | "leftIsDisplayAvailable" | "leftDisplayStatus" | "leftDisplayInformation" | "leftGetDisplayBrightness" | "leftDisplayContextCommands" | "leftDisplayReady" | "leftGetDisplaySpriteSheetName" | "leftGetLedInformation" | "leftDeviceInformation" | "leftNotConnected" | "leftIsConnected" | "leftBarometer" | "leftAcceleration" | "leftGravity" | "leftLinearAcceleration" | "leftGyroscope" | "leftMagnetometer" | "leftGameRotation" | "leftRotation" | "leftOrientation" | "leftStepDetector" | "leftStepCounter" | "leftActivity" | "leftDeviceOrientation" | "leftTapDetector" | "leftPressure" | "leftButtons" | "leftTouches" | "leftLight" | "leftConnectionMessage" | "leftConnectionStatus" | "leftIsLast" | "leftPressureAutoRangeEnabled" | "leftPressureAutoRangeDisabled" | "leftPressureAutoRange" | "leftPressureMotionAutoRangeEnabled" | "leftPressureMotionAutoRangeDisabled" | "leftPressureMotionAutoRange" | "leftIsRecordingPressureCalibrationData" | "leftPressureCalibrationDataRecordStart" | "leftPressureCalibrationDataRecordStop" | "leftPressureCalibrationDataRecordingProgress" | "leftIsTrainingPressureCalibration" | "leftPressureCalibrationTrainStart" | "leftPressureCalibrationTrainEnd" | "leftPressureCalibrationTrainProgress" | "leftCalibratedPressureModel" | "leftNumberOfButtons" | "leftButton" | "leftButtonDown" | "leftButtonUp" | "leftNumberOfTouches" | "leftTouch" | "leftTouchDown" | "leftTouchUp" | "leftFileTransferProgress" | "leftFileTransferComplete" | "leftFileReceived" | "leftFileSent" | "leftGetEnableWifiConnection" | "leftCameraImageProgress" | "leftCameraImage" | "leftIsRecordingCamera" | "leftCameraRecording" | "leftAutoPicture" | "leftStartRecordingCamera" | "leftStopRecordingCamera" | "leftIsRecordingMicrophone" | "leftMicrophoneRecording" | "leftStartRecordingMicrophone" | "leftStopRecordingMicrophone" | "leftDisplayContextState" | "leftDisplayColor" | "leftDisplayColorOpacity" | "leftDisplayOpacity" | "leftDisplaySpriteSheetUploadStart" | "leftDisplaySpriteSheetUploadProgress" | "leftDisplaySpriteSheetUploadComplete" | "leftSetLed" | "leftFirmwareImages" | "leftFirmwareUploadProgress" | "leftFirmwareStatus">(type: T) => void;
    get removeAllEventListeners(): () => void;
...
declare function addEventListeners(target: any, boundEventListeners: BoundGenericEventListeners, options?: AddEventListenerOptions): void;
...
export { BaseScanner, BluetoothConnectionManager, bluetoothUUIDs_d as BluetoothUUIDs, CameraCommands, CameraConfigurationTypes, CenterOfPressureModel, _default$2 as ClientManager, Clients, ConnectionEventTypes, ConnectionManagers, ConnectionMessageTypes, ConnectionStatuses, ContinuousSensorTypes, DefaultGuardManagerOptions, DefaultNumberOfDisplayColors, DefaultNumberOfPressureSensors, Device, DeviceEventTypes, _default$4 as DeviceManager, DevicePair, DevicePairTypes, DeviceTypes, DiscoveredDevice, DisplayAlignments, DisplayBezierCurveTypes, DisplayBrightnesses, DisplayContextCommandTypes, DisplayDirections, DisplayPixelDepths, DisplaySegmentCaps, DisplaySpriteContextCommandTypes, environment_d as Environment, EventUtils, FileTransferDirections, FileTypes, GuardManager, LedTypes, LedValueTypes, MaxNameLength, MaxNumberOfVibrationWaveformEffectSegments, MaxNumberOfVibrationWaveformSegments, MaxSensorRate, MaxSpriteSheetNameLength, MaxVibrationWaveformEffectSegmentDelay, MaxVibrationWaveformEffectSegmentLoopCount, MaxVibrationWaveformEffectSequenceLoopCount, MaxVibrationWaveformSegmentDuration, MaxWifiPasswordLength, MaxWifiSSIDLength, MicrophoneBitDepths, MicrophoneCommands, MicrophoneConfigurationTypes, MicrophoneConfigurationValues, MicrophoneSampleRates, MinNameLength, MinSpriteSheetNameLength, MinWifiPasswordLength, MinWifiSSIDLength, _default$5 as NullScanner, _default$1 as PubSubManager, RangeHelper, RangeHelper2, _default as ScannerManager, SensorRateStep, SensorTypes, _default$3 as ServerManager, Servers, Sides, TfliteSensorTypes, TfliteTasks, ThrottleUtils, Timer, TxRxMessageTypes, UDPServer, VibrationLocations, VibrationTypes, VibrationWaveformEffects, WebSocketServer, concatenateArrayBuffers, displayCurveTypeToNumberOfControlPoints, englishRegex, fontToSpriteSheet, getFontMaxHeight, getFontMetrics, getFontUnicodeRange, getMaxSpriteSheetSize, getTensorFlowModel, hexToRGB, intersectWireframes, isTensorFlowAvailable, isTensorFlowModelAvailable, isWireframePolygon, listTensorflowModels, maxDisplayScale, mergeWireframes, parseFont, pixelDepthToNumberOfColors, projectColor, rgbToHex, setAllConsoleLevelFlags, setConsoleLevelFlagsForType, simplifyCurves, simplifyPoints, simplifyPointsAsCubicCurveControlPoints, stringToSprites, wait, wildcardEventType };
export type { BoundDeviceEventListeners, BoundDeviceManagerEventListeners, BoundDevicePairEventListeners, BoundServerEventListeners, CameraCommand, CameraConfiguration, CameraConfigurationType, CenterOfPressure, Client, ConnectionEventType, ConnectionManager, ConnectionMessageType, ConnectionStatus, ContinuousSensorType, DeviceEvent, DeviceEventListenerMap, DeviceEventMap, DeviceEventType, DeviceInformation, DeviceManagerEvent, DeviceManagerEventListenerMap, DeviceManagerEventMap, DevicePairEvent, DevicePairEventListenerMap, DevicePairEventMap, DevicePairType, DeviceType, DiscoveredDeviceMetadata, DisplayAlignment, DisplayBezierCurveType, DisplayBitmap, DisplayBitmapColorPair, DisplayBrightness, DisplayColorRGB, DisplayColorRGBOrString, DisplayContextCommand, DisplayContextCommandType, DisplayDirection, DisplaySegmentCap, DisplaySize, DisplaySprite, DisplaySpriteColorPair, DisplaySpriteContextCommandType, DisplaySpriteLine, DisplaySpriteLines, DisplaySpritePaletteSwap, DisplaySpriteSheet, DisplaySpriteSheetPalette, DisplaySpriteSubLine, DisplayWireframe, DisplayWireframeEdge, Euler, EventDispatcherOptions, FileTransferDirection, FileType, FontMetrics, FontToSpriteSheetOptions, Guard, GuardManagerObject, GuardManagerOptions, Led, LedConfiguration, LedType, LedValue, LedValueType, MicrophoneBitDepth, MicrophoneCommand, MicrophoneConfiguration, MicrophoneConfigurationType, MicrophoneSampleRate, PressureData, PressureSensorPosition, PressureSensorValue, Quaternion, Range, ScannerLike, SensorConfiguration, SensorType, Server, ServerClient, ServerEvent, ServerEventDispatcher, ServerEventDispatcherTypes, ServerEventListenerMap, ServerEventMap, Side, TfliteFileConfiguration, TfliteSensorType, TfliteTask, TxRxMessageType, Vector2, Vector3, VibrationConfiguration, VibrationLocation, VibrationType, VibrationWaveformConfiguration, VibrationWaveformEffect, VibrationWaveformEffectConfiguration, VibrationWaveformEffectSegment, VibrationWaveformSegment, WildcardEventType };
