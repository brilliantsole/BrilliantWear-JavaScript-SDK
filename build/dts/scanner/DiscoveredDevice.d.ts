...
declare class DiscoveredDevice {
    ...
    get addEventListener(): <T extends "device" | "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "*" | "isWifiSecure" | "update" | "name" | "deviceType" | "rssi" | "expired">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<DiscoveredDevice, "device" | "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "isWifiSecure" | "update" | "name" | "deviceType" | "rssi" | "expired", DiscoveredDeviceEventMessages, T>) => void, options?: import("../utils/EventDispatcher.ts").EventDispatcherOptions) => void;
    get removeEventListener(): <T extends "device" | "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "*" | "isWifiSecure" | "update" | "name" | "deviceType" | "rssi" | "expired">(type: T, listener: (event: import("../utils/EventDispatcher.ts").ListenerEvent<DiscoveredDevice, "device" | "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "isWifiSecure" | "update" | "name" | "deviceType" | "rssi" | "expired", DiscoveredDeviceEventMessages, T>) => void) => void;
    get waitForEvent(): <T extends "device" | "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "isWifiSecure" | "update" | "name" | "deviceType" | "rssi" | "expired">(type: T, options?: {
        immediate?: boolean;
        signal?: AbortSignal;
    }) => Promise<import("../utils/EventDispatcher.ts").ListenerEvent<DiscoveredDevice, "device" | "notConnected" | "connecting" | "connected" | "disconnecting" | "connectionStatus" | "isConnected" | "ipAddress" | "isWifiSecure" | "update" | "name" | "deviceType" | "rssi" | "expired", DiscoveredDeviceEventMessages, T>>;
    toJSON(): {
        bluetoothId: string;
